...
# Il2CppInspector metadata-110 b4 output declares cardContainer at +0x330,
# selectedCards at +0x348 and cardsInHand at +0x350.
BOARD_CARD_CONTAINER_OFFSET = 0x330
BOARD_SELECTED_CARDS_OFFSET = 0x348
BOARD_CARDS_IN_HAND_OFFSET = 0x350
...
FUSION_CARD_UI_BUTTON_OFFSET = 0x60
FUSION_CARD_UI_NEXT_REFRESH_AT_OFFSET = 0x68
FUSION_CARD_UI_BOUND_PET_ID_OFFSET = 0x70
FUSION_CARD_UI_READ_SIZE = 0x78

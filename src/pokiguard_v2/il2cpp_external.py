...
# Verified for the current Pokiguard 1.7.4-b2 / metadata 110 build with
# Il2CppInspector output under reverse/reverse_1.7.4-b2 (preferred image base
# 0x180000000). These values intentionally do not support the superseded C67
# GameAssembly layout; game_location gates attachment by the exact new hash.
BOARD_TYPE_INFO_RVA = 0x2DA5890
ACTIVE_TYPE_INFO_RVA = 0x2D96E60
MANAGER_MATCH_TYPE_INFO_RVA = 0x2D947D0
MATCH_SERVICE_TYPE_INFO_RVA = 0x2D96548
CHAT_SERVICE_TYPE_INFO_RVA = 0x2DAD230
...
CHAT_MESSAGE_DTO_TYPE_INFO_RVA = 0x2DAD0B0
HUB_SUSPEND_MANAGER_TYPE_INFO_RVA = 0x2DE3C78
MATCH_HOST_TYPE_INFO_RVA = 0x2D95F88
MATCH_SCENE_LOADER_TYPE_INFO_RVA = 0x2D96490
TURN_ANNOUNCER_TYPE_INFO_RVA = 0x2DDAE68
DOT_TYPE_INFO_RVA = 0x2DCC268
WS_COMBAT_BATCH_TYPE_INFO_RVA = 0x2DEB350
BOARD_WS_APPLIER_TYPE_INFO_RVA = 0x2DA5B70
CARD_UI_TYPE_INFO_RVA = 0x2DAB7F0
FUSION_CARD_UI_TYPE_INFO_RVA = 0x2DD97E8
ACTIVE_PLAYER_STATS_TYPE_INFO_RVA = 0x2DFD1A0
PET_USER_DTO_TYPE_INFO_RVA = 0x2DA86D0
CARD_DATA_TYPE_INFO_RVA = 0x2DAB070
# Read-only websocket-dispatch roots verified in the 1.7.4-b2 Inspector output.
...
CHAT_SERVICE_MESSAGE_CLOSURE_TYPE_INFO_RVA = 0x2D97A60
UNITY_MAIN_THREAD_DISPATCHER_TYPE_INFO_RVA = 0x2DE08F8
UNITY_PENDING_ACTION_LIST_TYPE_INFO_RVA = 0x2DDB970
UNITY_PENDING_ACTION_QUEUE_TYPE_INFO_RVA = 0x2DE5D48
...
BOARD_IS_USING_LEGEND_CARD_OFFSET = 0x391
BOARD_IS_USING_MEGA_OFFSET = 0x398
BOARD_IS_RESUMING_OFFSET = 0x3B0
BOARD_IS_MEGA1_PANEL_OPEN_OFFSET = 0x470
...
MATCH_SERVICE_FUSION_ENABLED_OFFSET = 0x60
MATCH_SERVICE_FUSION_MANA_COST_OFFSET = 0x64
MATCH_SERVICE_FUSION_STAT_PERCENT_OFFSET = 0x68
MATCH_SERVICE_LOCAL_FUSION_USED_OFFSET = 0x6C
MATCH_SERVICE_LOCAL_FUSION_LAST_ATTEMPT_TURN_OFFSET = 0x70
MATCH_SERVICE_LOCAL_FUSION_SELECTED_USER_PET_ID_OFFSET = 0x78
MATCH_SERVICE_LOCAL_FUSION_SELECTED_PET_ID_OFFSET = 0x80
MATCH_SERVICE_LOCAL_FUSION_SKILL_CARD_OFFSET = 0x88
MATCH_SERVICE_LOCAL_FUSION_DROP_REASON_OFFSET = 0x90
MATCH_SERVICE_TURN_TIME_REMAINING_SEC_OFFSET = 0x138
MATCH_SERVICE_LOCAL_SEQ_NUM_OFFSET = 0xC0
MATCH_SERVICE_PENDING_COMBAT_OFFSET = 0x1A8
MATCH_SERVICE_LAST_REJECT_CARD_ID_OFFSET = 0x270
MATCH_SERVICE_HAS_SERVER_CLOCK_OFFSET = 0x164
MATCH_SERVICE_CLOCK_PAUSED_OFFSET = 0x165
MATCH_SERVICE_CLOCK_PAUSE_REASON_OFFSET = 0x168
MATCH_SERVICE_IN_FLIGHT_BATCHES_OFFSET = 0x1B0
MATCH_SERVICE_MATCH_OVER_OFFSET = 0x1EB
MATCH_SERVICE_RESYNC_COROUTINE_OFFSET = 0x1F0
MATCH_SERVICE_LAST_MOVE_FROM_COL_OFFSET = 0x1F8
MATCH_SERVICE_LAST_MOVE_FROM_ROW_OFFSET = 0x1FC
MATCH_SERVICE_LAST_MOVE_TO_COL_OFFSET = 0x200
MATCH_SERVICE_LAST_MOVE_TO_ROW_OFFSET = 0x204
MATCH_SERVICE_LAST_MOVE_SEQ_NUM_OFFSET = 0x208
MATCH_SERVICE_DEFERRED_WINNER_OFFSET = 0x280
MATCH_SERVICE_HAS_DEFERRED_GAME_OVER_OFFSET = 0x288

...
# Verified for Pokiguard 1.7.4 / metadata 110 with Il2CppInspectorRedux 2026.2
# output under reverse/pokiguard_1.7.4 (preferred image base 0x180000000).
BOARD_TYPE_INFO_RVA = 0x2BF22A0
ACTIVE_TYPE_INFO_RVA = 0x2BE5468
MANAGER_MATCH_TYPE_INFO_RVA = 0x2C53818
MATCH_SERVICE_TYPE_INFO_RVA = 0x2C54F68
CHAT_SERVICE_TYPE_INFO_RVA = 0x2BF8980
...
CHAT_MESSAGE_DTO_TYPE_INFO_RVA = 0x2BF88D8
HUB_SUSPEND_MANAGER_TYPE_INFO_RVA = 0x2C2A828
MATCH_HOST_TYPE_INFO_RVA = 0x2C54C30
MATCH_SCENE_LOADER_TYPE_INFO_RVA = 0x2C54EC0
DOT_TYPE_INFO_RVA = 0x2C15858
WS_COMBAT_BATCH_TYPE_INFO_RVA = 0x2C2FD80
BOARD_WS_APPLIER_TYPE_INFO_RVA = 0x2BF2540
...
BOARD_IS_GAME_OVER_OFFSET = 0x2B8
BOARD_IS_USING_LEGEND_CARD_OFFSET = 0x369
BOARD_IS_USING_MEGA_OFFSET = 0x370
BOARD_IS_RESUMING_OFFSET = 0x388
BOARD_IS_MEGA1_PANEL_OPEN_OFFSET = 0x428
...
MATCH_SERVICE_TURN_TIME_REMAINING_SEC_OFFSET = 0x120
MATCH_SERVICE_LOCAL_SEQ_NUM_OFFSET = 0xB0
MATCH_SERVICE_PENDING_COMBAT_OFFSET = 0x188
MATCH_SERVICE_LAST_REJECT_CARD_ID_OFFSET = 0x230
MATCH_SERVICE_HAS_SERVER_CLOCK_OFFSET = 0x144
MATCH_SERVICE_CLOCK_PAUSED_OFFSET = 0x145
MATCH_SERVICE_CLOCK_PAUSE_REASON_OFFSET = 0x148
MATCH_SERVICE_IN_FLIGHT_BATCHES_OFFSET = 0x190
MATCH_SERVICE_MATCH_OVER_OFFSET = 0x1CA
MATCH_SERVICE_RESYNC_COROUTINE_OFFSET = 0x1D0
MATCH_SERVICE_LAST_MOVE_FROM_COL_OFFSET = 0x1D8
MATCH_SERVICE_LAST_MOVE_FROM_ROW_OFFSET = 0x1DC
MATCH_SERVICE_LAST_MOVE_TO_COL_OFFSET = 0x1E0
MATCH_SERVICE_LAST_MOVE_TO_ROW_OFFSET = 0x1E4
MATCH_SERVICE_LAST_MOVE_SEQ_NUM_OFFSET = 0x1E8
MATCH_SERVICE_DEFERRED_WINNER_OFFSET = 0x240
MATCH_SERVICE_HAS_DEFERRED_GAME_OVER_OFFSET = 0x248
BOARD_RESULT_TITLE_OFFSET = 0x280
UNITY_UI_TEXT_VALUE_OFFSET = 0xE8
CHAT_SERVICE_IS_CONNECTED_OFFSET = 0x28
CHAT_SERVICE_USERNAME_OFFSET = 0x30
CHAT_SERVICE_EXPLICIT_DISCONNECT_OFFSET = 0x2A6
CHAT_SERVICE_RECONNECT_COROUTINE_OFFSET = 0x2A8
CHAT_SERVICE_CONNECTING_OFFSET = 0x2B4

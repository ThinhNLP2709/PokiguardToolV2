...
public class CardPhotonSync : MonoBehaviour // TypeDefIndex: 5
{
	...
	private const float GalaxyRickyChargeSec = 0.15f; // Metadata: 0x005EE5F0
	private const float HealConvertCastSec = 0.6f; // Metadata: 0x005EE5F4
	private const float GalaxyScanSec = 1f; // Metadata: 0x005EE5F8
	private const float GalaxyChargeSec = 0.8f; // Metadata: 0x005EE5FC
	private const float QtePrefetchWaitSec = 2f; // Metadata: 0x005EE600

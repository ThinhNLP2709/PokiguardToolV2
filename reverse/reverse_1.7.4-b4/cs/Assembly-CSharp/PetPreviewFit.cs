...
public class PetPreviewFit : MonoBehaviour // TypeDefIndex: 1434
{
	// Fields
	...
	// Nested types
	public enum Anchor // TypeDefIndex: 1435
	{
		Center = 0,
		Bottom = 1,
		None = 2
	...
	// Constructors
	public PetPreviewFit(); // 0x00000001807CDB80-0x00000001807CDC10

	// Methods
	private void Awake(); // 0x00000001807CC9F0-0x00000001807CCB20
	private void OnEnable(); // 0x00000001807CCB20-0x00000001807CCBA0
	private void SaveHome(); // 0x00000001807CCBA0-0x00000001807CCCC0
	public void Refit(); // 0x00000001807CA920-0x00000001807CA980
	public void PlayPop(float from = 0.8f /* Metadata: 0x005F0F56 */, float duration = 0.3f /* Metadata: 0x005F0F5A */); // 0x00000001807CCCC0-0x00000001807CCD00
	public void PlayPunch(float peak = 1.15f /* Metadata: 0x005F0F5E */, float duration = 0.4f /* Metadata: 0x005F0F62 */); // 0x00000001807CCD00-0x00000001807CCD50
	public void SetTarget(float width, float height); // 0x00000001807CA980-0x00000001807CAA00
	private void LateUpdate(); // 0x00000001807CCD50-0x00000001807CD6F0
	private bool NeedsRefit(Sprite sp); // 0x00000001807CD6F0-0x00000001807CD8B0
	private void Recompute(Sprite sp); // 0x00000001807CD8B0-0x00000001807CDB80
}

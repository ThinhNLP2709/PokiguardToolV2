...
public class FeatureFlagGate : MonoBehaviour // TypeDefIndex: 1390
{
	// Fields
	...
	// Nested types
	public enum GateMode // TypeDefIndex: 1391
	{
		Hide = 0,
		Disable = 1
	}
	...
	// Constructors
	public FeatureFlagGate(); // 0x0000000180300D90-0x0000000180300DE0

	// Methods
	private void Awake(); // 0x0000000180786540-0x0000000180786600
	private void OnEnable(); // 0x0000000180786600-0x0000000180786610
	private void OnDestroy(); // 0x0000000180786610-0x00000001807866C0
	private void Capture(); // 0x00000001807866C0-0x00000001807868C0
	private void Apply(); // 0x00000001807868C0-0x0000000180786B60
}

...
public class CoopMatchResultHelper : MonoBehaviour // TypeDefIndex: 1192
{
	// Fields
	public static CoopMatchResultHelper Instance; // 0x00
	private const int MAX_RETRIES = 3; // Metadata: 0x005F094A
	private const float RETRY_DELAY = 2f; // Metadata: 0x005F094B
	...
	// Properties
	public int lastRewardGold { get; } // 0x0000000180665480-0x00000001806654A0 
	public int lastRewardExp { get; } // 0x00000001806CDD20-0x00000001806CDD40 

	// Events
	public event Action<string> OnRewardPushed {
		add; // 0x00000001806CDAE0-0x00000001806CDC00
		remove; // 0x00000001806CDC00-0x00000001806CDD20
	}

	// Nested types
	[Serializable]
	private class MatchResponse // TypeDefIndex: 1193
	{
		// Fields
	...
	[Serializable]
	public class MatchRewardData // TypeDefIndex: 1194
	{
		// Fields
	...
	[CompilerGenerated]
	private sealed class __c__DisplayClass21_0 // TypeDefIndex: 1195
	{
		// Fields
		public bool success; // 0x10
	...
	[CompilerGenerated]
	private sealed class __c__DisplayClass21_1 // TypeDefIndex: 1196
	{
		// Fields
		...
		// Methods
		internal void _SubmitMatchResult_b__0(string response); // 0x00000001806CF520-0x00000001806CF560
		internal void _SubmitMatchResult_b__1(string error); // 0x00000001806CF560-0x00000001806CF5F0
	}

	[CompilerGenerated]
	private sealed class _PostRawJson_d__23 : IEnumerator<object> // TypeDefIndex: 1197
	{
		// Fields
		...
		// Methods
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001806CF5F0-0x00000001806CF720
		private bool MoveNext(); // 0x00000001806CF720-0x00000001806CFCD0
		private void __m__Finally1(); // 0x00000001806CFCD0-0x00000001806CFD30
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001806CFD30-0x00000001806CFD70
	}

	[CompilerGenerated]
	private sealed class _SubmitMatchResult_d__21 : IEnumerator<object> // TypeDefIndex: 1198
	{
		// Fields
		private int __1__state; // 0x10
		private object __2__current; // 0x18
		...
		// Methods
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001806CFD70-0x00000001806CFF20
		private bool MoveNext(); // 0x00000001806CFF20-0x00000001806D1AA0
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001806D1AA0-0x00000001806D1AE0
	}
	...
	private static void AutoInitialize(); // 0x00000001806CDD40-0x00000001806CDEC0
	private void Awake(); // 0x00000001806CDEC0-0x00000001806CE160
	private void TrySubscribeWs(); // 0x00000001806CE160-0x00000001806CE430
	private void OnDestroy(); // 0x00000001806CE430-0x00000001806CE7C0
	private void HandleWsMatchResultPush(ChatMessageDTO msg); // 0x00000001806CE7C0-0x00000001806CEE20
	private static string ResolveCurrentSubmitMatchId(); // 0x00000001806CEE20-0x00000001806CEEA0
	[IteratorStateMachine(typeof(_SubmitMatchResult_d__21))]
	public IEnumerator SubmitMatchResult(bool playerWon, int turnCount, string mode = "coop" /* Metadata: 0x005F0935 */, long enemyUserId = 0 /* Metadata: 0x005F093A */, long petId = 0 /* Metadata: 0x005F0942 */); // 0x00000001806CEEA0-0x00000001806CEFF0
	private void ParseResponse(string response); // 0x00000001806CEFF0-0x00000001806CF210
	[IteratorStateMachine(typeof(_PostRawJson_d__23))]
	private IEnumerator PostRawJson(string url, string jsonBody, Action<string> onSuccess, Action<string> onError); // 0x00000001806CF210-0x00000001806CF3C0
	private string Esc(string s); // 0x00000001806CF3C0-0x00000001806CF520
}

...
public class PokyRewardCellView : MonoBehaviour // TypeDefIndex: 1172
{
	// Fields
	...
	private const string PIECE_SPRITE = "Image/piece/pet_piece"; // Metadata: 0x005F08D8
	private static Sprite _pieceSprite; // 0x00
	private static bool _pieceLoaded; // 0x08

	// Constructors
	public PokyRewardCellView(); // 0x00000001806C0B50-0x00000001806C0BA0

	// Methods
	public void Bind(Sprite icon, string amount, bool isPiece); // 0x00000001806C01C0-0x00000001806C0930
	private static Sprite LoadPiece(); // 0x00000001806C0930-0x00000001806C0B50
}

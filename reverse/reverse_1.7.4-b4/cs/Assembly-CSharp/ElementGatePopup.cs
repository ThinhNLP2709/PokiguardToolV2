...
{
	// Fields
	private const string BG_SPRITE = "Image/FusionUI/bgPopupAlert"; // Metadata: 0x005EE8EF
	private const string BTN_SPRITE = "Image/FusionUI/btnBlue"; // Metadata: 0x005EE90B
	private const string CELL_BG_SPRITE = "Image/petK/Circle Bg Dark"; // Metadata: 0x005EE922
	private const string GLOW_SPRITE = "Image/FusionUI/haoquang"; // Metadata: 0x005EE93C
	private const float PANEL_W = 900f; // Metadata: 0x005EE954
	private const float PANEL_H = 580f; // Metadata: 0x005EE958
	private const float CELL = 118f; // Metadata: 0x005EE95C
	private const float CELL_GAP = 34f; // Metadata: 0x005EE960

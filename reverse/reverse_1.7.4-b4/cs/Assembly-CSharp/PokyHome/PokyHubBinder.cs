...
namespace PokyHome
{
	...
	public class PokyHubBinder : MonoBehaviour // TypeDefIndex: 2625
	{
		// Fields
		...
		private const string ARENA_ICON_NODE = "IconStone"; // Metadata: 0x005F262D
	
		// Properties
		public int BoundCount { [CompilerGenerated] get; [CompilerGenerated] private set; } // 0x000000018029B0F0-0x000000018029B100 0x0000000180C183C0-0x0000000180C183D0
	
		// Constructors
		public PokyHubBinder(); // 0x000000018028A560-0x000000018028A5B0
	
		// Methods
		public void Apply(ManagerQuangTruong hub); // 0x0000000180C183D0-0x0000000180C191A0
		private void ApplyHonorIcon(); // 0x0000000180C191A0-0x0000000180C19520
		public void RefreshNow(); // 0x0000000180C19520-0x0000000180C196A0
		public void Restore(); // 0x0000000180C196A0-0x0000000180C1A060
		private void OnDestroy(); // 0x0000000180C1A060-0x0000000180C1A070

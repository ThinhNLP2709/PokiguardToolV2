...
namespace PokyHome
{
	...
	public class PokyKhoPetSkin : MonoBehaviour // TypeDefIndex: 2686
	{
		// Fields
		...
		// Constructors
		public PokyKhoPetSkin(); // 0x0000000180C48190-0x0000000180C482D0
	
		// Methods
		private void Awake(); // 0x0000000180C47420-0x0000000180C47870
		private static Image IconOf(Button slot); // 0x0000000180C47870-0x0000000180C47A90
		private void LateUpdate(); // 0x0000000180C47A90-0x0000000180C47E10
		private static void Mute(Button b); // 0x0000000180C47E10-0x0000000180C47FD0
		private static void Unmute(Button b); // 0x0000000180C47FD0-0x0000000180C48190
	}
}

...
namespace PokyHome
{
	...
	public class PokyRankBoardAdapter : MonoBehaviour // TypeDefIndex: 2695
	{
		// Fields
		...
		// Methods
		private void OnEnable(); // 0x0000000180C53500-0x0000000180C53B40
		private void PreparePetAnimator(Transform row); // 0x0000000180C53B40-0x0000000180C54080
	}
}

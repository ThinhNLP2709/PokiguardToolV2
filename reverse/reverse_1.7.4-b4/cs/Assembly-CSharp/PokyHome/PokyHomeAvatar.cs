...
namespace PokyHome
{
	...
	public class PokyHomeAvatar : MonoBehaviour // TypeDefIndex: 2644
	{
		// Fields
		...
		// Constructors
		public PokyHomeAvatar(); // 0x0000000180C2A740-0x0000000180C2A790
	
		// Methods
		public void Bind(UserDTO user); // 0x0000000180C2A100-0x0000000180C2A620
		private void OnDestroy(); // 0x0000000180C2A620-0x0000000180C2A740
	}
}

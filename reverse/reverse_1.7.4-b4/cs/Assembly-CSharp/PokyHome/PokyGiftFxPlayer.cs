...
namespace PokyHome
{
	...
	public class PokyGiftFxPlayer : MonoBehaviour // TypeDefIndex: 2681
	{
		// Fields
		public const float FPS_POKY = 60f; // Metadata: 0x005F27F6
		public const int POKY_TICKS_PER_FRAME = 6; // Metadata: 0x005F27FA
		public const float POKY_SPIN_PER_TICK = -0.8f; // Metadata: 0x005F27FB
		...
		// Properties
		public bool IsFinished { get; } // 0x0000000180C44590-0x0000000180C445A0 
		public int CurrentFrame { get; } // 0x000000018046B9E0-0x000000018046B9F0 
		public int FrameCount { get; } // 0x0000000180C445A0-0x0000000180C445C0 
		private bool HasFrames { get; } // 0x0000000180C449C0-0x0000000180C449E0 
	
		// Nested types
		public enum PlayMode // TypeDefIndex: 2682
		{
			Loop = 0,
			Once = 1,
			PingPong = 2
		...
		// Constructors
		public PokyGiftFxPlayer(); // 0x0000000180C45260-0x0000000180C452C0
	
		// Methods
		public static PlayMode FromPokyTypeAnim(int typeAnim); // 0x0000000180C44570-0x0000000180C44590
		private void Awake(); // 0x0000000180C445C0-0x0000000180C446F0
		public void Play(); // 0x0000000180C446F0-0x0000000180C44700
		private void OnEnable(); // 0x0000000180C446F0-0x0000000180C44700
		private void Restart(); // 0x0000000180C44700-0x0000000180C449C0
		private void ApplyFrame(); // 0x0000000180C449E0-0x0000000180C44D10
		private void Update(); // 0x0000000180C44D10-0x0000000180C45030
		private void Advance(); // 0x0000000180C45030-0x0000000180C450D0
		private void EndOnce(); // 0x0000000180C450D0-0x0000000180C45260
	}
}

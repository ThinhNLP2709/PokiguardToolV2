...
namespace PokyHome
{
	...
	public class PokyHomeGiftTime : MonoBehaviour // TypeDefIndex: 2649
	{
		// Fields
		...
		// Constructors
		public PokyHomeGiftTime(); // 0x0000000180C2A740-0x0000000180C2A790
	
		// Methods
		private void Awake(); // 0x0000000180C2CF60-0x0000000180C2D1F0
		public void SetCount(int count); // 0x0000000180C2D1F0-0x0000000180C2D4C0
	}
}

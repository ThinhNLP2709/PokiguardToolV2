...
public class Display_InvitableUser : MonoBehaviour, IHubSuspendable // TypeDefIndex: 28
{
	...
	private const float REFRESH_DEBOUNCE_DELAY = 1f; // Metadata: 0x005EE983
	...
	private const string SUFFIX_BUSY = " (\u0111ang b\u1EADn)"; // Metadata: 0x005EE987
	private const string SUFFIX_OFFLINE = " (ngo\u1EA1i tuy\u1EBFn)"; // Metadata: 0x005EE996
	...
	private sealed class _LoadFriends_d__43 : IEnumerator<object> // TypeDefIndex: 34
	{
		...
		private bool MoveNext(); // 0x00000001802B5230-0x00000001802B5AB0
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001802B5AB0-0x00000001802B5AF0
	}
	...
	private sealed class _LoadUsersAndWatch_d__44 : IEnumerator<object> // TypeDefIndex: 35
	{
		...
		// Methods
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001802B5AF0-0x00000001802B5C50
		private bool MoveNext(); // 0x00000001802B5C50-0x00000001802B6B20
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001802B6B20-0x00000001802B6B60
	}
	...
	private sealed class _RefreshDebounced_d__40 : IEnumerator<object> // TypeDefIndex: 36
	{
		...
		private bool MoveNext(); // 0x00000001802B6B70-0x00000001802B6D70
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001802B6D70-0x00000001802B6DB0
	}

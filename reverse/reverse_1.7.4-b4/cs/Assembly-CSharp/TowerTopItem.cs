...
public class TowerTopItem : MonoBehaviour // TypeDefIndex: 1370
{
	// Fields
	[Header("H\u1EA1ng")]
	...
	// Methods
	public void Init(TowerTopRow row, bool isMe); // 0x000000018077B630-0x000000018077C0A0
	private void ApplyRank(int rank); // 0x000000018077C0A0-0x000000018077C640
}

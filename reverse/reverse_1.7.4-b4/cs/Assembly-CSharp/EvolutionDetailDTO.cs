...
[Serializable]
public class EvolutionDetailDTO // TypeDefIndex: 651
{
	// Fields
	...
	public long sourceSkillCardId; // 0x88
	public string sourceSkillCardName; // 0x90
	public string sourceSkillCardDesc; // 0x98
	public int sourceSkillCardMana; // 0xA0
	public int sourceSkillCardPower; // 0xA4
	public long targetSkillCardId; // 0xA8
	public string targetSkillCardName; // 0xB0
	public string targetSkillCardDesc; // 0xB8
	public int targetSkillCardMana; // 0xC0
	public int targetSkillCardPower; // 0xC4

	// Constructors
	public EvolutionDetailDTO(); // 0x000000018028A320-0x000000018028A330
}

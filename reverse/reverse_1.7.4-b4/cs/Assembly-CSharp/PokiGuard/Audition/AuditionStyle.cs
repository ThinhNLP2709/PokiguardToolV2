...
{
	public sealed class AuditionStyle // TypeDefIndex: 2552
	{
		// Fields
		...
		// Properties
		public bool LegacyArrows { get; } // 0x0000000180BD5B30-0x0000000180BD5BC0 
	
		// Constructors
		public AuditionStyle(); // 0x0000000180BD7490-0x0000000180BD7BC0
	
		// Methods
		private static Color Hex(string s); // 0x0000000180BD5BC0-0x0000000180BD5C80
		public static AuditionStyle Load(); // 0x0000000180BD5C80-0x0000000180BD6DC0
		private static float Num(JObject o, string key, float def, float min, float max); // 0x0000000180BD6DC0-0x0000000180BD7020
		private static string Skin(JObject o, string key, string def); // 0x0000000180BD7020-0x0000000180BD7150
		private static Color Col(JObject o, string key, Color def); // 0x0000000180BD7150-0x0000000180BD7310
		private static string Str(JObject o, string key, string def, int maxLen); // 0x0000000180BD7310-0x0000000180BD7490
	}
}

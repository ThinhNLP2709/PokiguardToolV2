...
public static class SettingsApi // TypeDefIndex: 1205
{
	// Nested types
	[Serializable]
	public class RenameInfoData // TypeDefIndex: 1206
	{
		// Fields
	...
	[Serializable]
	public class RenameRes // TypeDefIndex: 1207
	{
		// Fields
	...
	[Serializable]
	private class RenameReq // TypeDefIndex: 1208
	{
		// Fields
	...
	// Methods
	public static Coroutine GetRenameInfo(int userId, Action<RenameInfoData> onOk, Action<string> onErr); // 0x00000001806D37B0-0x00000001806D3A60
	public static Coroutine Rename(int userId, string newName, Action<RenameRes> onOk, Action<string> onErr); // 0x00000001806D3A60-0x00000001806D3DA0
}

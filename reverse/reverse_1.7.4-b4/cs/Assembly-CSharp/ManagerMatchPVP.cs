...
public class ManagerMatchPVP : MonoBehaviour // TypeDefIndex: 204
{
	...
	// Properties
	public SpriteRenderer PetHostUser { get; } // 0x0000000180B0D4C0-0x0000000180B0D6C0 
	public SpriteRenderer PetHostEnemy { get; } // 0x0000000180B0D6C0-0x0000000180B0D8C0 

	// Events
	public event Action OnAllDataLoaded {
		add; // 0x0000000180B0D8C0-0x0000000180B0D9C0
		remove; // 0x0000000180B0D9C0-0x0000000180B0DAC0
	}
	...
	private sealed class __c__DisplayClass84_0 // TypeDefIndex: 207
	{
		...
		// Methods
		internal void _LoadSceneAfterDelay_b__0(MatchPrepDataDTO data); // 0x0000000180C7F270-0x0000000180C7F6E0
		internal void _LoadSceneAfterDelay_b__1(string err); // 0x00000001802D8AB0-0x00000001802D8B10
		internal bool _LoadSceneAfterDelay_b__2(); // 0x0000000180C7F6E0-0x0000000180C7F720
	}
	...
	private sealed class _LoadSceneAfterDelay_d__84 : IEnumerator<object> // TypeDefIndex: 208
	{
		...
		private bool MoveNext(); // 0x0000000180C7F720-0x0000000180C80A30
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x0000000180C80A30-0x0000000180C80A70
	}
	...
	private sealed class _SetupOpponentUIWhenReady_d__81 : IEnumerator<object> // TypeDefIndex: 209
	{
		...
		private bool MoveNext(); // 0x0000000180C80A70-0x0000000180C80DD0
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x0000000180C80DD0-0x0000000180C80E10
	}
	...
	private sealed class _WaitForOpponentProps_d__85 : IEnumerator<object> // TypeDefIndex: 210
	{
		...
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001802B6B60-0x00000001802B6B70
		private bool MoveNext(); // 0x0000000180C80E10-0x0000000180C80F70
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x0000000180C80F70-0x0000000180C80FB0
	}

	// Constructors
	public ManagerMatchPVP(); // 0x0000000180B12A20-0x0000000180B12EA0

	// Methods
	private void Awake(); // 0x0000000180B0DAC0-0x0000000180B0DC80
	private void OnDestroy(); // 0x0000000180B0DC80-0x0000000180B0DE60
	private void Start(); // 0x0000000180B0DE60-0x0000000180B0E0B0
	private void WireEnergyBuyButton(); // 0x0000000180B0E0B0-0x0000000180B0E5C0
	private void OpenEnergyPurchasePopup(); // 0x00000001805F3640-0x00000001805F3650
	private void InitDebugGuiStyles(); // 0x0000000180B0E5C0-0x0000000180B0EB20
	private void Update(); // 0x0000000180B0EB20-0x0000000180B0EBA0
	private void UpdatePingFpsHud(); // 0x0000000180B0EBA0-0x0000000180B0EF80
	private void UpdateDebugStatsRealtime(); // 0x0000000180B0EF80-0x0000000180B0FCF0
	private void ShowPopupDelta(int actor, string statName, int delta); // 0x0000000180B0FCF0-0x0000000180B0FF30
	public string GetPlayerName(int actor); // 0x0000000180B0FF30-0x0000000180B10390
	private void InitializeDisplayActor(); // 0x0000000180B10390-0x0000000180B10440
	[IteratorStateMachine(typeof(_SetupOpponentUIWhenReady_d__81))]
	private IEnumerator SetupOpponentUIWhenReady(); // 0x0000000180B10440-0x0000000180B104E0
	private void CheckAndUpdateDisplayActor(); // 0x0000000180B104E0-0x0000000180B10560
	public void SwitchDisplayToPlayer(int actorNumber); // 0x0000000180B10560-0x0000000180B10780
	[IteratorStateMachine(typeof(_LoadSceneAfterDelay_d__84))]
	private IEnumerator LoadSceneAfterDelay(); // 0x0000000180B10780-0x0000000180B10820
	[IteratorStateMachine(typeof(_WaitForOpponentProps_d__85))]
	private IEnumerator WaitForOpponentProps(); // 0x0000000180B10820-0x0000000180B108C0
	private MatchPlayerSnapshotDTO GetOpponentSnapshotWs(); // 0x0000000180B108C0-0x0000000180B11030
	private void OnPet(string petId); // 0x0000000180B11030-0x0000000180B112D0
	private void OnEnemyPet(string petId); // 0x0000000180B112D0-0x0000000180B11570
	private void OnPetsReceived(PetUserDTO pets); // 0x0000000180B11570-0x0000000180B11D70
	private void OnEPetsReceived(PetUserDTO pets); // 0x0000000180B11D70-0x0000000180B125A0
	private void RefreshWeaknessLabels(); // 0x0000000180B125A0-0x0000000180B12990
	private void OnError(string error); // 0x0000000180B12990-0x0000000180B12A10
	public void AddBossDamage(int damage); // 0x0000000180B12A10-0x0000000180B12A20

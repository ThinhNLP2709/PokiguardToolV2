...
public class UIEffect : MonoBehaviour // TypeDefIndex: 2397
{
	// Fields
	...
	// Nested types
	[CompilerGenerated]
	private sealed class _DisplayAndFade_d__5 : IEnumerator<object> // TypeDefIndex: 2398
	{
		// Fields
		...
		private bool MoveNext(); // 0x0000000180B67940-0x0000000180B67E90
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x0000000180B67E90-0x0000000180B67ED0
	}

	// Constructors
	public UIEffect(); // 0x0000000180B678E0-0x0000000180B67940

	// Methods
	public void ShowWithEffect(string text); // 0x0000000180B676E0-0x0000000180B67840
	[IteratorStateMachine(typeof(_DisplayAndFade_d__5))]
	private IEnumerator DisplayAndFade(); // 0x0000000180B67840-0x0000000180B678E0
}

...
{
	// Fields
	private const string ROOM_TYPE = "ChinhPhuc"; // Metadata: 0x005EE615
	private const string PANEL_PREFAB_PATH = "Prefabs/UI/CoopRoomListPanel"; // Metadata: 0x005EE61F
	private const string STATUS_CONNECTING = "\u0110ang k\u1EBFt n\u1ED1i m\u00E1y ch\u1EE7..."; // Metadata: 0x005EE63C
	private const string STATUS_LOADING = "\u0110ang t\u1EA3i danh s\u00E1ch ph\u00F2ng..."; // Metadata: 0x005EE65C
	private const string STATUS_EMPTY = "Ch\u01B0a c\u00F3 ph\u00F2ng n\u00E0o \u0111ang m\u1EDF.\nH\u00E3y t\u1EA1o ph\u00F2ng v\u00E0 r\u1EE7 b\u1EA1n b\u00E8 c\u00F9ng s\u0103n boss!"; // Metadata: 0x005EE67D

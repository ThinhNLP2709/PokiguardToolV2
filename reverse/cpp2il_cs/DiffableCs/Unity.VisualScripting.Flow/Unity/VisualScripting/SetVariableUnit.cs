...
{
	[CompilerGenerated]
	private ControlInput <assign>k__BackingField; //Field offset: 0xA0
	[CompilerGenerated]
	private ValueInput <input>k__BackingField; //Field offset: 0xA8
	[CompilerGenerated]
	private ControlOutput <assigned>k__BackingField; //Field offset: 0xB0
	[CompilerGenerated]
	...
	protected override ControlOutput Assign(Flow flow) { }

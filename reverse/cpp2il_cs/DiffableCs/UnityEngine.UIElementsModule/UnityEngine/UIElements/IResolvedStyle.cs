...
public interface IResolvedStyle
{
	...
	public IEnumerable<TimeValue> get_transitionDelay() { }

	public IEnumerable<TimeValue> get_transitionDuration() { }

	public IEnumerable<StylePropertyName> get_transitionProperty() { }

	public IEnumerable<EasingFunction> get_transitionTimingFunction() { }

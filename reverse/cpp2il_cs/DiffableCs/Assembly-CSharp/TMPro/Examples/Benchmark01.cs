...
public class Benchmark01 : MonoBehaviour
{
	...
	private sealed class <Start>d__10 : IEnumerator<Object>, IEnumerator, IDisposable
	{
		...
		public Benchmark01 <>4__this; //Field offset: 0x20
	...
	private const string label01 = "The <#0050FF>count is: </color>{0}"; //Field offset: 0x0
	private const string label02 = "The <color=#0050FF>count is: </color>"; //Field offset: 0x0
	public int BenchmarkType; //Field offset: 0x20
	public TMP_FontAsset TMProFont; //Field offset: 0x28
	public Font TextMeshFont; //Field offset: 0x30
	private TextMeshPro m_textMeshPro; //Field offset: 0x38
	private TextContainer m_textContainer; //Field offset: 0x40
	private TextMesh m_textMesh; //Field offset: 0x48

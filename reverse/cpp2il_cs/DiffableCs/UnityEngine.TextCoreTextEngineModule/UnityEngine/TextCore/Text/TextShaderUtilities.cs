...
public static class TextShaderUtilities
{
	...
	private static Shader k_ShaderRef_MobileSDF_IMGUI; //Field offset: 0x150
	private static Shader k_ShaderRef_MobileBitmap; //Field offset: 0x158
	private static Shader k_ShaderRef_Sprite; //Field offset: 0x160

	internal static Shader ShaderRef_MobileBitmap
	{
		internal get { } //Length: 550
	}

	internal static Shader ShaderRef_MobileSDF
	{
		[VisibleToOtherModules(new IL2CPP_TYPE_STRING[] {"UnityEngine.UIElementsModule"})]
		internal get { } //Length: 526
	}

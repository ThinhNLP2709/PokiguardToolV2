...
public class PetPreviewFit : MonoBehaviour // TypeDefIndex: 1432
{
	// Fields
	...
	// Nested types
	public enum Anchor // TypeDefIndex: 1433
	{
		Center = 0,
		Bottom = 1,
		None = 2
	...
	// Constructors
	public PetPreviewFit(); // 0x00000001807CBB10-0x00000001807CBBA0

	// Methods
	private void Awake(); // 0x00000001807CA980-0x00000001807CAAB0
	private void OnEnable(); // 0x00000001807CAAB0-0x00000001807CAB30
	private void SaveHome(); // 0x00000001807CAB30-0x00000001807CAC50
	public void Refit(); // 0x00000001807C88B0-0x00000001807C8910
	public void PlayPop(float from = 0.8f /* Metadata: 0x005EFB89 */, float duration = 0.3f /* Metadata: 0x005EFB8D */); // 0x00000001807CAC50-0x00000001807CAC90
	public void PlayPunch(float peak = 1.15f /* Metadata: 0x005EFB91 */, float duration = 0.4f /* Metadata: 0x005EFB95 */); // 0x00000001807CAC90-0x00000001807CACE0
	public void SetTarget(float width, float height); // 0x00000001807C8910-0x00000001807C8990
	private void LateUpdate(); // 0x00000001807CACE0-0x00000001807CB680
	private bool NeedsRefit(Sprite sp); // 0x00000001807CB680-0x00000001807CB840
	private void Recompute(Sprite sp); // 0x00000001807CB840-0x00000001807CBB10
}

...
public class QuangTruongWeather : MonoBehaviour // TypeDefIndex: 2111
{
	// Fields
	[Header("B\u1EADt/t\u1EAFt")]
	...
	// Nested types
	public enum Weather // TypeDefIndex: 2112
	{
		None = 0,
		Rain = 1,
		Snow = 2,
	...
	public enum Mode // TypeDefIndex: 2113
	{
		AutoByHour = 0,
		Manual = 1
	}

	private class Drop // TypeDefIndex: 2114
	{
		// Fields
	...
	// Constructors
	public QuangTruongWeather(); // 0x0000000180A03400-0x0000000180A035B0

	// Methods
	private void Start(); // 0x00000001809FFB40-0x00000001809FFD10
	private void ShutdownWeather(); // 0x00000001809FFD10-0x0000000180A002D0
	public void SetWeatherEnabled(bool on); // 0x0000000180A002D0-0x0000000180A00730
	private bool IsWeatherVisible(); // 0x0000000180A00730-0x0000000180A00AA0
	private void Update(); // 0x0000000180A00AA0-0x0000000180A00DE0
	public void Apply(); // 0x0000000180A00DE0-0x0000000180A00F70
	private Weather WeatherForHour(int hour); // 0x0000000180A00F70-0x0000000180A00FE0
	private static bool InRange(int hour, int start, int end); // 0x0000000180A00FE0-0x0000000180A01090
	private bool BuildContainer(); // 0x0000000180A01090-0x0000000180A01A60
	private static void Stretch(RectTransform rt); // 0x0000000180A01A60-0x0000000180A01BB0
	private void RebuildDrops(Weather w); // 0x0000000180A01BB0-0x0000000180A01FD0
	private Vector2 CanvasSize(); // 0x0000000180A01FD0-0x0000000180A020F0
	private Drop MakeDrop(Weather w); // 0x0000000180A020F0-0x0000000180A02830
	private void StepDrops(); // 0x0000000180A02830-0x0000000180A02D30
	private Sprite MakeSprite(bool line); // 0x0000000180A02D30-0x0000000180A03400
}

...
public class ActivePVP : MonoBehaviour // TypeDefIndex: 93
{
	...
	public const int WS_NO_BOSS = 0; // Metadata: 0x005ED6DA
	[Header("UI Object")]
	...
	// Properties
	public int LocalOpponentActorNumber { get; } // 0x0000000180481120-0x0000000180481150 
	internal int localActorNumber { get; } // 0x0000000180481150-0x00000001804813B0 
	internal int HandleUISyncPendingCount { get; } // 0x00000001804815B0-0x00000001804815D0 
	public int CurrentTurnIndex { get; } // 0x0000000180481B20-0x0000000180481B30 
	...
	public bool IsMyTurn { get; } // 0x0000000180481B50-0x0000000180481B80 
	public float CurrentTurnTime { get; } // 0x0000000180481B80-0x0000000180481B90 
	public static ActivePVP Instance { [CompilerGenerated] get; [CompilerGenerated] internal set; } // 0x0000000180482490-0x00000001804824D0 0x00000001804824D0-0x0000000180482570
	public List<int> ActivePlayers { get; } // 0x0000000180482570-0x0000000180482580 
	public int CurrentTurnPlayerActorNumber { get; } // 0x0000000180482A10-0x0000000180482CD0 

	// Events
	public event Action OnTurnEnd {
		add; // 0x00000001804813B0-0x00000001804814B0
		remove; // 0x00000001804814B0-0x00000001804815B0
	}
	public event Action<int> OnTurnStart {
		add; // 0x0000000180481B90-0x0000000180481CB0
		remove; // 0x0000000180481CB0-0x0000000180481DD0
	}
	public event Action<int> OnTurnEndInternal {
		add; // 0x0000000180481DD0-0x0000000180481EF0
		remove; // 0x0000000180481EF0-0x0000000180482010
	}
	public event Action<int, float> OnTurnTimeUpdate {
		add; // 0x0000000180482010-0x0000000180482130
		remove; // 0x0000000180482130-0x0000000180482250
	}
	public event Action<int> OnTurnTimeout {
		add; // 0x0000000180482250-0x0000000180482370
		remove; // 0x0000000180482370-0x0000000180482490
	}
	...
	private sealed class __c // TypeDefIndex: 96
	{
		...
		// Constructors
		static __c(); // 0x00000001807A27C0-0x00000001807A2860
		public __c(); // 0x000000018028A320-0x000000018028A330

		// Methods
		internal int _InitializeStatsFromWsSnapshot_b__180_0(MatchPlayerSnapshotDTO a, MatchPlayerSnapshotDTO b); // 0x00000001807A2860-0x00000001807A28B0
	}
	...
	private sealed class _AnimateSlider_d__183 : IEnumerator<object> // TypeDefIndex: 97
	{
		...
		private bool MoveNext(); // 0x00000001807A28B0-0x00000001807A2B80
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A2B80-0x00000001807A2BC0
	}
	...
	private sealed class _AutoResetPetAnimationsAfter_d__212 : IEnumerator<object> // TypeDefIndex: 98
	{
		...
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001802B6B30-0x00000001802B6B40
		private bool MoveNext(); // 0x00000001807A2BC0-0x00000001807A2D10
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A2D10-0x00000001807A2D50
	}
	...
	private sealed class _FadeAndMoveUpBoth_d__203 : IEnumerator<object> // TypeDefIndex: 99
	{
		...
		private bool MoveNext(); // 0x00000001807A2EB0-0x00000001807A3700
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A3700-0x00000001807A3740
	}
	...
	private sealed class _FadeAndMoveUpSafe_d__202 : IEnumerator<object> // TypeDefIndex: 100
	{
		...
		private bool MoveNext(); // 0x00000001807A3740-0x00000001807A3CE0
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A3CE0-0x00000001807A3D20
	}
	...
	private sealed class _OutputsParam_d__185 : IEnumerator<object> // TypeDefIndex: 101
	{
		...
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001802B6B30-0x00000001802B6B40
		private bool MoveNext(); // 0x00000001807A3D20-0x00000001807A3E00
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A3E00-0x00000001807A3E40
	}
	...
	private sealed class _OutputsParam_d__201 : IEnumerator<object> // TypeDefIndex: 102
	{
		...
		private bool MoveNext(); // 0x00000001807A3F50-0x00000001807A4CC0
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A4CC0-0x00000001807A4D00
	}
	...
	private sealed class _PopupStacked_d__200 : IEnumerator<object> // TypeDefIndex: 103
	{
		...
		private bool MoveNext(); // 0x00000001807A4D00-0x00000001807A5370
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A5370-0x00000001807A53B0
	}
	...
	private sealed class _RageSpendPopupRoutine_d__196 : IEnumerator<object> // TypeDefIndex: 104
	{
		...
		// Methods
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001807A53B0-0x00000001807A5420
		private bool MoveNext(); // 0x00000001807A5420-0x00000001807A5770
		private void __m__Finally1(); // 0x00000001807A5770-0x00000001807A58E0
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A58E0-0x00000001807A5920
	}
	...
	private sealed class _RenderWsBuffsTogether_d__199 : IEnumerator<object> // TypeDefIndex: 105
	{
		...
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001802B6B30-0x00000001802B6B40
		private bool MoveNext(); // 0x00000001807A5920-0x00000001807A6030
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A6030-0x00000001807A6070
	}
	...
	private sealed class _RenderWsCombat_d__189 : IEnumerator<object> // TypeDefIndex: 106
	{
		...
		private bool MoveNext(); // 0x00000001807A6070-0x00000001807A6870
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A6870-0x00000001807A68B0
	}
	...
	private sealed class _RenderWsCombatTag_d__198 : IEnumerator<object> // TypeDefIndex: 107
	{
		...
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001802B6B30-0x00000001802B6B40
		private bool MoveNext(); // 0x00000001807A68B0-0x00000001807A70C0
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A70C0-0x00000001807A7100
	}
	...
	private sealed class _RenderWsLifesteal_d__192 : IEnumerator<object> // TypeDefIndex: 108
	{
		...
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001802B6B30-0x00000001802B6B40
		private bool MoveNext(); // 0x00000001807A7100-0x00000001807A7290
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A7290-0x00000001807A72D0
	}
	...
	private sealed class _SetAnimationForItemActor_d__214 : IEnumerator<object> // TypeDefIndex: 109
	{
		...
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001802B6B30-0x00000001802B6B40
		private bool MoveNext(); // 0x00000001807A72D0-0x00000001807A7B30
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A7B30-0x00000001807A7B70
	}
	...
	private sealed class _ShowBlockPopup_d__191 : IEnumerator<object> // TypeDefIndex: 110
	{
		...
		[DebuggerHidden]
		void IDisposable.Dispose(); // 0x00000001802B6B30-0x00000001802B6B40
		private bool MoveNext(); // 0x00000001807A7B70-0x00000001807A7E50
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001807A7E50-0x00000001807A7E90
	}

	// Constructors
	public ActivePVP(); // 0x00000001804882C0-0x0000000180488720

	// Methods
	public void SyncStatsListForInspector(); // 0x0000000180480F50-0x0000000180481120
	internal void ClearHandleUISyncQueue(); // 0x00000001804815D0-0x0000000180481600
	internal void EnqueueHandleUISyncFromMaster(HandleUISyncPayload p); // 0x0000000180481600-0x0000000180481670
	internal bool TryApplyNextHandleUISync(); // 0x0000000180481670-0x0000000180481B20
	internal void Awake(); // 0x0000000180482580-0x0000000180482700
	private void Start(); // 0x0000000180482700-0x0000000180482A10
	public bool IsCurrentPlayerTurn(int actorNumber); // 0x0000000180482CD0-0x0000000180482CF0
	public void InitializeStatsFromWsSnapshot(); // 0x0000000180482CF0-0x0000000180483700
	public int ResolveWsActor(string username); // 0x0000000180483700-0x00000001804838D0
	public void ApplyWsTurn(string currentTurnPlayerUsername, int serverTurnNumber); // 0x00000001804838D0-0x00000001804839D0
	[IteratorStateMachine(typeof(_AnimateSlider_d__183))]
	public IEnumerator AnimateSlider(Slider slider, float targetValue, float duration = 0.4f /* Metadata: 0x005ED6CE */); // 0x00000001804839D0-0x0000000180483A90
	internal void HandleTurnStartInternal(int entityIndex); // 0x0000000180483A90-0x0000000180483AC0
	[IteratorStateMachine(typeof(_OutputsParam_d__185))]
	public IEnumerator OutputsParam(string itemType); // 0x0000000180483AC0-0x0000000180483BD0
	private Active.DamagePopupStyle ResolveDamagePopupStyle(GameObject root, bool rightSide); // 0x0000000180483BD0-0x0000000180483E00
	[IteratorStateMachine(typeof(_RenderWsCombat_d__189))]
	public IEnumerator RenderWsCombat(List<WsCombatStepDTO> steps, int attackerActor, bool wasFullPower = false /* Metadata: 0x005ED6D2 */, bool isSkill = false /* Metadata: 0x005ED6D3 */, bool auditionSkill = false /* Metadata: 0x005ED6D4 */); // 0x0000000180483E00-0x0000000180483F40
	[IteratorStateMachine(typeof(_ShowBlockPopup_d__191))]
	internal IEnumerator ShowBlockPopup(GameObject node, int amount); // 0x0000000180483F40-0x0000000180484050
	[IteratorStateMachine(typeof(_RenderWsLifesteal_d__192))]
	public IEnumerator RenderWsLifesteal(int amount, int attackerActor); // 0x0000000180484050-0x0000000180484110
	public Dictionary<string, int> BuildWsOutputsByTag(List<WsCombatStepDTO> steps); // 0x0000000180484110-0x0000000180484790
	private void ShowRageSpendPopup(int attackerActor); // 0x0000000180484790-0x0000000180484A20
	[IteratorStateMachine(typeof(_RageSpendPopupRoutine_d__196))]
	private IEnumerator RageSpendPopupRoutine(GameObject node); // 0x0000000180484A20-0x0000000180484B30
	private void PlayImpactFx(int attackerActor, int damage); // 0x0000000180484B30-0x0000000180484DA0
	[IteratorStateMachine(typeof(_RenderWsCombatTag_d__198))]
	public IEnumerator RenderWsCombatTag(string tag, int amount, int attackerActor, bool wasFullPower, bool isSkill = false /* Metadata: 0x005ED6D5 */, bool auditionSkill = false /* Metadata: 0x005ED6D6 */); // 0x0000000180484DA0-0x0000000180484EE0
	[IteratorStateMachine(typeof(_RenderWsBuffsTogether_d__199))]
	public IEnumerator RenderWsBuffsTogether(List<KeyValuePair<string, int>> items, int attackerActor, bool wasFullPower); // 0x0000000180484EE0-0x0000000180485010
	[IteratorStateMachine(typeof(_PopupStacked_d__200))]
	private IEnumerator PopupStacked(string tag, int attackerActor, int row); // 0x0000000180485010-0x0000000180485140
	[IteratorStateMachine(typeof(_OutputsParam_d__201))]
	public IEnumerator OutputsParam(string itemType, int attackerActor, bool isSkill = false /* Metadata: 0x005ED6D7 */); // 0x0000000180485140-0x0000000180485270
	[IteratorStateMachine(typeof(_FadeAndMoveUpSafe_d__202))]
	internal IEnumerator FadeAndMoveUpSafe(GameObject obj, float duration); // 0x0000000180485270-0x0000000180485330
	[IteratorStateMachine(typeof(_FadeAndMoveUpBoth_d__203))]
	internal IEnumerator FadeAndMoveUpBoth(GameObject obj1, GameObject obj2, float duration); // 0x0000000180485330-0x0000000180485450
	public Animator GetPetAnimatorForActor(int actorNumber); // 0x0000000180485450-0x00000001804854A0
	public void UpdateShieldIcons(); // 0x00000001804854A0-0x0000000180486290
	internal void HandleTurnEndInternal(int entityIndex); // 0x0000000180486290-0x0000000180486640
	public void resetOutput(); // 0x0000000180486640-0x0000000180486680
	public void IncreaseNoPlayer(CardInfo cardInfo); // 0x0000000180486680-0x0000000180487030
	internal void ResetPetAnimations(); // 0x0000000180487030-0x00000001804871F0
	internal void ScheduleAutoResetPetAnimations(float delaySec); // 0x00000001804871F0-0x00000001804873A0
	[IteratorStateMachine(typeof(_AutoResetPetAnimationsAfter_d__212))]
	private IEnumerator AutoResetPetAnimationsAfter(float delaySec); // 0x00000001804873A0-0x0000000180487460
	public IEnumerator SetAnimationForItem(string itemType, bool wasFullPower = false /* Metadata: 0x005ED6D8 */); // 0x0000000180487460-0x00000001804874B0
	[IteratorStateMachine(typeof(_SetAnimationForItemActor_d__214))]
	public IEnumerator SetAnimationForItemActor(string itemType, bool wasFullPower, int actorOverride, bool rageBurst = true /* Metadata: 0x005ED6D9 */); // 0x00000001804874B0-0x00000001804875F0
	public void RaiseTurnStart(int actorNumber); // 0x00000001804875F0-0x0000000180487610
	...
	public int GetOpponentOf(int actorNumber); // 0x0000000180487670-0x0000000180487C00
	public bool RemovePlayerFromActiveTurns(int actorNumber); // 0x0000000180487C00-0x0000000180487CA0
	public bool IsActorStillInRoom(int actorNumber); // 0x0000000180487CA0-0x0000000180487F90
	internal void OnDestroy(); // 0x0000000180487F90-0x00000001804882C0
	[CompilerGenerated]
	private void _UpdateShieldIcons_b__205_0(); // 0x0000000180488720-0x00000001804887B0
	[CompilerGenerated]
	private void _UpdateShieldIcons_b__205_1(); // 0x00000001804887B0-0x0000000180488D00
}

...
public class PlayerUISlotPVP : MonoBehaviour // TypeDefIndex: 226
{
	...
	private const int LEGACY_IDX_IMAGE_AVT = 1; // Metadata: 0x005ED98B
	private const int LEGACY_IDX_LEVEL = 2; // Metadata: 0x005ED98C
	private const int LEGACY_IDX_USERNAME = 3; // Metadata: 0x005ED98D
	private const int LEGACY_IDX_PET = 4; // Metadata: 0x005ED98E
	private const int LEGACY_IDX_ENERGY = 5; // Metadata: 0x005ED98F
	private const int LEGACY_IDX_PASS = 6; // Metadata: 0x005ED990
	...
	private const float RANK_POS_TTL = 120f; // Metadata: 0x005ED991
	private const float RANK_POS_FAIL_BACKOFF = 30f; // Metadata: 0x005ED995
	...
	private sealed class __c__DisplayClass37_0 // TypeDefIndex: 227
	{
		...
		// Methods
		internal void _SetData_b__0(); // 0x0000000180C96750-0x0000000180C967C0
	}
	...
	private sealed class __c__DisplayClass44_0 // TypeDefIndex: 228
	{
		...
		// Methods
		internal void _ReplacePetAnimations_b__0(AnimationClip[] clips); // 0x0000000180C967C0-0x0000000180C96940
	}
	...
	private sealed class __c__DisplayClass52_0 // TypeDefIndex: 229
	{
		...
		// Methods
		internal void _LoadRankPositionForSlot_b__0(PvpProfileDTO data); // 0x0000000180C96940-0x0000000180C96D40
		internal void _LoadRankPositionForSlot_b__1(string err); // 0x0000000180C96D40-0x0000000180C96E70
	}

	// Constructors
	public PlayerUISlotPVP(); // 0x0000000180C96410-0x0000000180C96460
	static PlayerUISlotPVP(); // 0x0000000180C96460-0x0000000180C96750

	// Methods
	private void Awake(); // 0x0000000180C91880-0x0000000180C918B0
	private void Start(); // 0x0000000180C918B0-0x0000000180C91A10
	private void AutoFillMissingRefs(); // 0x0000000180C91A10-0x0000000180C931A0
	public void SetData(PlayerUIModel model); // 0x0000000180C931A0-0x0000000180C94D30
	private static bool IsWsOwner(string userName); // 0x0000000180C94D30-0x0000000180C94E20
	public void ReplacePetAnimations(string petId); // 0x0000000180C94E20-0x0000000180C957B0
	private void ApplyPetClipsPvp(string petId, AnimationClip[] clips); // 0x0000000180C957B0-0x0000000180C95D40
	private void LoadRankPositionForSlot(int userId); // 0x0000000180C95D40-0x0000000180C96410
}

...
{
	// Fields
	public const string NODE_NAME = "[CoopRoomGuide]"; // Metadata: 0x005ED4B2
	private const float FRAME_W = 1774f; // Metadata: 0x005ED4C2
	private const float FRAME_H = 887f; // Metadata: 0x005ED4C6
	private const float DIM_OVERSCAN = 600f; // Metadata: 0x005ED4CA
	private const float BOX_W = 1320f; // Metadata: 0x005ED4CE
	private const float BOX_H = 780f; // Metadata: 0x005ED4D2
	private const float BOX_X = 227f; // Metadata: 0x005ED4D6
	private const float BOX_Y = 44f; // Metadata: 0x005ED4DA
	private const float TITLE_Y = 18f; // Metadata: 0x005ED4DE
	private const float TITLE_H = 54f; // Metadata: 0x005ED4E2
	private const float TITLE_FS = 38f; // Metadata: 0x005ED4E6
	private const float CLOSE_X = 1222f; // Metadata: 0x005ED4EA
	private const float CLOSE_Y = 12f; // Metadata: 0x005ED4EE
	private const float CLOSE_W = 78f; // Metadata: 0x005ED4F2
	private const float CLOSE_H = 80f; // Metadata: 0x005ED4F6
	private const float VP_X = 34f; // Metadata: 0x005ED4FA
	private const float VP_Y = 96f; // Metadata: 0x005ED4FE
	private const float VP_W = 1252f; // Metadata: 0x005ED502
	private const float VP_H = 636f; // Metadata: 0x005ED506
	private const float HINT_Y = 740f; // Metadata: 0x005ED50A
	private const float HINT_H = 28f; // Metadata: 0x005ED50E
	private const float HEAD_FS = 30f; // Metadata: 0x005ED512
	private const float BODY_FS = 24f; // Metadata: 0x005ED516
	private const float DIV_H = 2f; // Metadata: 0x005ED51A

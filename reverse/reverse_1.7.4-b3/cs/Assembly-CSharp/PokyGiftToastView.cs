...
public class PokyGiftToastView : MonoBehaviour // TypeDefIndex: 1168
{
	// Fields
	...
	public const float FADE = 0.22f; // Metadata: 0x005EF503
	private const float SLIDE = 26f; // Metadata: 0x005EF507

	// Nested types
	[CompilerGenerated]
	private sealed class _CoPlay_d__8 : IEnumerator<object> // TypeDefIndex: 1169
	{
		// Fields
		...
		private bool MoveNext(); // 0x00000001806BDDC0-0x00000001806BE680
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001806BE680-0x00000001806BE6C0
	}
	...
	// Methods
	public void Play(string message, Sprite icon, string amount, float duration, float offsetY = 0f /* Metadata: 0x005EF4FF */); // 0x00000001806BD360-0x00000001806BDD00
	[IteratorStateMachine(typeof(_CoPlay_d__8))]
	private IEnumerator CoPlay(float duration); // 0x00000001806BDD00-0x00000001806BDDC0
}

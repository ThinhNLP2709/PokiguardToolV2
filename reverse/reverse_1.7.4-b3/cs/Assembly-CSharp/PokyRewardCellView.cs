...
public class PokyRewardCellView : MonoBehaviour // TypeDefIndex: 1170
{
	// Fields
	...
	private const string PIECE_SPRITE = "Image/piece/pet_piece"; // Metadata: 0x005EF50B
	private static Sprite _pieceSprite; // 0x00
	private static bool _pieceLoaded; // 0x08

	// Constructors
	public PokyRewardCellView(); // 0x00000001806BF050-0x00000001806BF0A0

	// Methods
	public void Bind(Sprite icon, string amount, bool isPiece); // 0x00000001806BE6C0-0x00000001806BEE30
	private static Sprite LoadPiece(); // 0x00000001806BEE30-0x00000001806BF050
}

...
public class FeatureFlagGate : MonoBehaviour // TypeDefIndex: 1388
{
	// Fields
	...
	// Nested types
	public enum GateMode // TypeDefIndex: 1389
	{
		Hide = 0,
		Disable = 1
	}
	...
	// Constructors
	public FeatureFlagGate(); // 0x0000000180300D60-0x0000000180300DB0

	// Methods
	private void Awake(); // 0x00000001807845F0-0x00000001807846B0
	private void OnEnable(); // 0x00000001807846B0-0x00000001807846C0
	private void OnDestroy(); // 0x00000001807846C0-0x0000000180784770
	private void Capture(); // 0x0000000180784770-0x0000000180784970
	private void Apply(); // 0x0000000180784970-0x0000000180784C10
}

...
public class PetImageFit : MonoBehaviour // TypeDefIndex: 1428
{
	// Fields
	...
	// Properties
	public Vector2 Home { get; } // 0x00000001807C8130-0x00000001807C8150 
	public float Fit { get; } // 0x00000001807C8150-0x00000001807C8160 
	public Vector2 DesignSize { get; } // 0x00000001807C8160-0x00000001807C82A0 

	// Nested types
	public enum Anchor // TypeDefIndex: 1429
	{
		Center = 0,
		Bottom = 1,
		None = 2
	...
	// Constructors
	public PetImageFit(); // 0x00000001807CA550-0x00000001807CA630

	// Methods
	private void Awake(); // 0x00000001807C82A0-0x00000001807C82C0
	private void CaptureDesignSize(); // 0x00000001807C82C0-0x00000001807C8450
	public void ResetToDesignSize(); // 0x00000001807C8450-0x00000001807C85D0
	private void OnEnable(); // 0x00000001807C85D0-0x00000001807C8670
	private void OnDisable(); // 0x00000001807C8670-0x00000001807C88B0
	public void Refit(); // 0x00000001807C88B0-0x00000001807C8910
	public void SetTarget(float width, float height); // 0x00000001807C8910-0x00000001807C8990
	public void RecaptureHome(); // 0x00000001807C8990-0x00000001807C8AB0
	public void SetHome(Vector2 home); // 0x00000001807C8AB0-0x00000001807C8AC0
	public void PlayPop(float from = 0.8f /* Metadata: 0x005EFB76 */, float duration = 0.3f /* Metadata: 0x005EFB7A */); // 0x00000001807C8AC0-0x00000001807C8B20
	public void PlayPunch(float peak = 1.15f /* Metadata: 0x005EFB7E */, float duration = 0.4f /* Metadata: 0x005EFB82 */); // 0x00000001807C8B20-0x00000001807C8B70
	public void Apply(Sprite sp); // 0x00000001807C8B70-0x00000001807C8DE0
	private void EnsureParts(); // 0x00000001807C8DE0-0x00000001807C9230
	private void LateUpdate(); // 0x00000001807C9230-0x00000001807C9750
	private void TickPop(); // 0x00000001807C9750-0x00000001807C9960
	private void WriteRect(); // 0x00000001807C9960-0x00000001807C9AE0
	private bool NeedsRefit(Sprite sp); // 0x00000001807C9AE0-0x00000001807C9D00
	private void Recompute(Sprite sp); // 0x00000001807C9D00-0x00000001807CA160
	private bool TryContentBounds(Sprite sp, out Vector2 min, out Vector2 max); // 0x00000001807CA160-0x00000001807CA550
}

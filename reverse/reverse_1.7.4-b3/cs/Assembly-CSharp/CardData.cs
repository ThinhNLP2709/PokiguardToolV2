...
[Serializable]
public class CardData // TypeDefIndex: 1689
{
	// Fields
	public long id; // 0x10
	...
	public int petStar; // 0x9C
	public int starSkillDamagePct; // 0xA0
	public int starSkillManaDiscountPct; // 0xA4
	public int starSkillPowerDiscountPct; // 0xA8

	// Properties
	public bool HasStarAwakening { get; } // 0x00000001808B0530-0x00000001808B0550 

	// Constructors
	public CardData(); // 0x00000001808B0550-0x00000001808B0570
}

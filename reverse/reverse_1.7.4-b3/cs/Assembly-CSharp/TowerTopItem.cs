...
public class TowerTopItem : MonoBehaviour // TypeDefIndex: 1368
{
	// Fields
	[Header("H\u1EA1ng")]
	...
	// Constructors
	public TowerTopItem(); // 0x000000018028A560-0x000000018028A5B0

	// Methods
	public void Init(TowerTopRow row, bool isMe); // 0x00000001807796E0-0x000000018077A150
	private void ApplyRank(int rank); // 0x000000018077A150-0x000000018077A6F0
}

...
public static class CoopRoomArt // TypeDefIndex: 12
{
	...
	public static void Stretch(RectTransform rt, float left = 0f /* Metadata: 0x005ED234 */, float bottom = 0f /* Metadata: 0x005ED238 */, float right = 0f /* Metadata: 0x005ED23C */, float top = 0f /* Metadata: 0x005ED240 */); // 0x00000001802944F0-0x00000001802945D0
	public static void Place(RectTransform rt, Vector2 anchor, Vector2 pos, Vector2 size); // 0x00000001802945D0-0x0000000180294670
	public static UnityEngine.UI.Text Label(string name, Transform parent, string content, int size, TextAnchor anchor, Color color, Color? outline, bool bold = false /* Metadata: 0x005ED244 */); // 0x0000000180294670-0x00000001802949F0

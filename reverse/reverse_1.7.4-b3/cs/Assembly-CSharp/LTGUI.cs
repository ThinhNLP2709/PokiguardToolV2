...
public class LTGUI // TypeDefIndex: 330
{
	...
	// Constructors
	static LTGUI(); // 0x00000001802FB2D0-0x00000001802FB380

	// Methods
	public static void reset(); // 0x00000001802FB0A0-0x00000001802FB1F0
	public static void destroy(int id); // 0x00000001802FB1F0-0x00000001802FB2D0
}

...
public static class ShaderWarmup // TypeDefIndex: 1807
{
	// Fields
	...
	// Nested types
	[CompilerGenerated]
	private sealed class _WarmCo_d__6 : IEnumerator<object> // TypeDefIndex: 1808
	{
		// Fields
		...
		private bool MoveNext(); // 0x00000001808EAEA0-0x00000001808EB3F0
		[DebuggerHidden]
		void IEnumerator.Reset(); // 0x00000001808EB3F0-0x00000001808EB430
	}

	// Methods
	[IteratorStateMachine(typeof(_WarmCo_d__6))]
	public static IEnumerator WarmCo(); // 0x00000001808EAE60-0x00000001808EAEA0
}

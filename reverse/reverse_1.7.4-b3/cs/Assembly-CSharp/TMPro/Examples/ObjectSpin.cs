...
{
	public class ObjectSpin : MonoBehaviour // TypeDefIndex: 2473
	{
		// Fields
		...
		// Nested types
		public enum MotionType // TypeDefIndex: 2474
		{
			Rotation = 0,
			SearchLight = 1,
			Translation = 2
		...
		// Constructors
		public ObjectSpin(); // 0x0000000180B857C0-0x0000000180B85840
	
		// Methods
		private void Awake(); // 0x0000000180B85050-0x0000000180B85370
		private void Update(); // 0x0000000180B85370-0x0000000180B857C0
	}
}

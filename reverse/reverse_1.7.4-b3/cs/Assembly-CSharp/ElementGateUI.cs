...
{
	// Fields
	private const string ROOT_NAME = "elementGateBar"; // Metadata: 0x005ED594
	private const float CELL_SIZE = 48f; // Metadata: 0x005ED5A3
	private const float CELL_GAP = 6f; // Metadata: 0x005ED5A7
	private const float BUTTON_GAP = 16f; // Metadata: 0x005ED5AB
	private const float FALLBACK_TOP_OFFSET = -178f; // Metadata: 0x005ED5AF

...
namespace PokyHome
{
	...
	public class PokySkinCanvasFit : MonoBehaviour // TypeDefIndex: 2695
	{
		// Fields
		...
		// Constructors
		public PokySkinCanvasFit(); // 0x0000000180C4B060-0x0000000180C4B0D0
	
		// Methods
		private void OnEnable(); // 0x0000000180C4A030-0x0000000180C4A150
		private void LateUpdate(); // 0x0000000180C4A150-0x0000000180C4A5D0
		public void Fit(); // 0x0000000180C4A5D0-0x0000000180C4B060

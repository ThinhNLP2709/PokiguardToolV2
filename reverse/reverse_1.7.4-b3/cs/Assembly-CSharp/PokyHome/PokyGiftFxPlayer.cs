...
namespace PokyHome
{
	...
	public class PokyGiftFxPlayer : MonoBehaviour // TypeDefIndex: 2674
	{
		// Fields
		public const float FPS_POKY = 60f; // Metadata: 0x005F13DF
		public const int POKY_TICKS_PER_FRAME = 6; // Metadata: 0x005F13E3
		public const float POKY_SPIN_PER_TICK = -0.8f; // Metadata: 0x005F13E4
		...
		// Properties
		public bool IsFinished { get; } // 0x0000000180C37130-0x0000000180C37140 
		public int CurrentFrame { get; } // 0x000000018046A770-0x000000018046A780 
		public int FrameCount { get; } // 0x0000000180C37140-0x0000000180C37160 
		private bool HasFrames { get; } // 0x0000000180C37560-0x0000000180C37580 
	
		// Nested types
		public enum PlayMode // TypeDefIndex: 2675
		{
			Loop = 0,
			Once = 1,
			PingPong = 2
		...
		// Constructors
		public PokyGiftFxPlayer(); // 0x0000000180C37E00-0x0000000180C37E60
	
		// Methods
		public static PlayMode FromPokyTypeAnim(int typeAnim); // 0x0000000180C37110-0x0000000180C37130
		private void Awake(); // 0x0000000180C37160-0x0000000180C37290
		public void Play(); // 0x0000000180C37290-0x0000000180C372A0
		private void OnEnable(); // 0x0000000180C37290-0x0000000180C372A0
		private void Restart(); // 0x0000000180C372A0-0x0000000180C37560
		private void ApplyFrame(); // 0x0000000180C37580-0x0000000180C378B0
		private void Update(); // 0x0000000180C378B0-0x0000000180C37BD0
		private void Advance(); // 0x0000000180C37BD0-0x0000000180C37C70
		private void EndOnce(); // 0x0000000180C37C70-0x0000000180C37E00
	}
}

...
namespace PokyHome.InfoPlayer
{
	...
	public class EquipBagFilterStateView : MonoBehaviour // TypeDefIndex: 2774
	{
		// Fields
		...
		// Constructors
		public EquipBagFilterStateView(); // 0x0000000180CC2870-0x0000000180CC2A60
	
		// Methods
		public void Refresh(EquipCategory category, EquipSlot activeSlot, bool sortByPower); // 0x0000000180CC1E20-0x0000000180CC2020
		private void RefreshTabs(EquipCategory active, EquipSlot activeSlot); // 0x0000000180CC2020-0x0000000180CC25C0
		private void RefreshSlotFilters(EquipSlot active); // 0x0000000180CC25C0-0x0000000180CC2870
	}
}

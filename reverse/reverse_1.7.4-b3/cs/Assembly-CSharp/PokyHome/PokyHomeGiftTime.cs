...
namespace PokyHome
{
	...
	public class PokyHomeGiftTime : MonoBehaviour // TypeDefIndex: 2642
	{
		// Fields
		...
		// Constructors
		public PokyHomeGiftTime(); // 0x0000000180C1CF60-0x0000000180C1CFB0
	
		// Methods
		private void Awake(); // 0x0000000180C1F780-0x0000000180C1FA10
		public void SetCount(int count); // 0x0000000180C1FA10-0x0000000180C1FCE0
	}
}

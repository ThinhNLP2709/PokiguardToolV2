...
namespace PokyHome
{
	...
	public class PokyKhoPetSkin : MonoBehaviour // TypeDefIndex: 2679
	{
		// Fields
		...
		// Constructors
		public PokyKhoPetSkin(); // 0x0000000180C3AD30-0x0000000180C3AE70
	
		// Methods
		private void Awake(); // 0x0000000180C39FC0-0x0000000180C3A410
		private static Image IconOf(Button slot); // 0x0000000180C3A410-0x0000000180C3A630
		private void LateUpdate(); // 0x0000000180C3A630-0x0000000180C3A9B0
		private static void Mute(Button b); // 0x0000000180C3A9B0-0x0000000180C3AB70
		private static void Unmute(Button b); // 0x0000000180C3AB70-0x0000000180C3AD30
	}
}

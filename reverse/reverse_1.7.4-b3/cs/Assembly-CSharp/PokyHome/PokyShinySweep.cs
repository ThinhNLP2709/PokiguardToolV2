...
namespace PokyHome
{
	...
	public class PokyShinySweep : MonoBehaviour // TypeDefIndex: 2691
	{
		// Fields
		...
		// Nested types
		[CompilerGenerated]
		private sealed class __c__DisplayClass10_0 // TypeDefIndex: 2692
		{
			// Fields
			...
			// Methods
			internal void _Play_b__0(float v); // 0x0000000180C48660-0x0000000180C48790
			internal void _Play_b__1(); // 0x0000000180C48790-0x0000000180C48980
		}
	
		// Constructors
		public PokyShinySweep(); // 0x0000000180C48600-0x0000000180C48660
	
		// Methods
		private void OnEnable(); // 0x0000000180C47B80-0x0000000180C47EF0
		private void OnDisable(); // 0x0000000180C47EF0-0x0000000180C480E0
		private void Update(); // 0x0000000180C480E0-0x0000000180C482E0
		private void Play(); // 0x0000000180C482E0-0x0000000180C48600
	}
}

...
namespace PokyHome
{
	...
	public class PokyHubBinder : MonoBehaviour // TypeDefIndex: 2618
	{
		// Fields
		...
		private const string ARENA_ICON_NODE = "IconStone"; // Metadata: 0x005F1216
	
		// Properties
		public int BoundCount { [CompilerGenerated] get; [CompilerGenerated] private set; } // 0x000000018029B0F0-0x000000018029B100 0x0000000180C0AE70-0x0000000180C0AE80
	
		// Constructors
		public PokyHubBinder(); // 0x000000018028A560-0x000000018028A5B0
	
		// Methods
		public void Apply(ManagerQuangTruong hub); // 0x0000000180C0AE80-0x0000000180C0BC50
		private void ApplyHonorIcon(); // 0x0000000180C0BC50-0x0000000180C0BFD0
		public void RefreshNow(); // 0x0000000180C0BFD0-0x0000000180C0C150
		public void Restore(); // 0x0000000180C0C150-0x0000000180C0CB10
		private void OnDestroy(); // 0x0000000180C0CB10-0x0000000180C0CC30

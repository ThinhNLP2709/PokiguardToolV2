...
public class PetPreviewFit : MonoBehaviour // TypeDefIndex: 1053
{
	// Fields
	...
	// Nested types
	public enum Anchor // TypeDefIndex: 1054
	{
		Center = 0,
		Bottom = 1,
		None = 2
	...
	// Constructors
	public PetPreviewFit(); // 0x0000000180503700-0x0000000180503750

	// Methods
	private void Awake(); // 0x0000000180502D60-0x0000000180502E10
	private void OnEnable(); // 0x00000001805033C0-0x0000000180503400
	private void SaveHome(); // 0x0000000180503660-0x0000000180503700
	public void Refit(); // 0x0000000180502380-0x00000001805023A0
	public void PlayPop(float from = 0.8f /* Metadata: 0x0068C34A */, float duration = 0.3f /* Metadata: 0x0068C34E */); // 0x0000000180503400-0x0000000180503440
	public void PlayPunch(float peak = 1.15f /* Metadata: 0x0068C352 */, float duration = 0.4f /* Metadata: 0x0068C356 */); // 0x0000000180503440-0x0000000180503490
	public void SetTarget(float width, float height); // 0x0000000180502470-0x00000001805024A0
	private void LateUpdate(); // 0x0000000180502E10-0x00000001805032E0
	private bool NeedsRefit(Sprite sp); // 0x00000001805032E0-0x00000001805033C0
	private void Recompute(Sprite sp); // 0x0000000180503490-0x0000000180503660
}

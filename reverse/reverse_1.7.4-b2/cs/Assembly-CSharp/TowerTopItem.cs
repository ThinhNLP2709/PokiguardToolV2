...
public class TowerTopItem : MonoBehaviour // TypeDefIndex: 998
{
	// Fields
	[Header("H\u1EA1ng")]
	...
	// Constructors
	public TowerTopItem(); // 0x00000001802EBA70-0x00000001802EBAF0

	// Methods
	public void Init(TowerTopRow row, bool isMe); // 0x00000001804F2ED0-0x00000001804F34F0
	private void ApplyRank(int rank); // 0x00000001804F2D10-0x00000001804F2ED0
}

...
public class PokyRewardCellView : MonoBehaviour // TypeDefIndex: 911
{
	// Fields
	...
	private const string PIECE_SPRITE = "Image/piece/pet_piece"; // Metadata: 0x0068BF1F
	private static Sprite _pieceSprite; // 0x00
	private static bool _pieceLoaded; // 0x08

	// Constructors
	public PokyRewardCellView(); // 0x00000001804D5330-0x00000001804D5340

	// Methods
	public void Bind(Sprite icon, string amount, bool isPiece); // 0x00000001804D4E50-0x00000001804D5200
	private static Sprite LoadPiece(); // 0x00000001804D5200-0x00000001804D5330
}

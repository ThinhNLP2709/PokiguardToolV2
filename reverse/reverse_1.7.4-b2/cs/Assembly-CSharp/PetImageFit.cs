...
public class PetImageFit : MonoBehaviour // TypeDefIndex: 1049
{
	// Fields
	...
	// Properties
	public Vector2 Home { get; } // 0x0000000180502BB0-0x0000000180502BD0 
	public float Fit { get; } // 0x0000000180502BA0-0x0000000180502BB0 
	public Vector2 DesignSize { get; } // 0x0000000180502B00-0x0000000180502BA0 

	// Nested types
	public enum Anchor // TypeDefIndex: 1050
	{
		Center = 0,
		Bottom = 1,
		None = 2
	...
	// Constructors
	public PetImageFit(); // 0x0000000180502A60-0x0000000180502B00

	// Methods
	private void Awake(); // 0x00000001805016E0-0x0000000180501700
	private void CaptureDesignSize(); // 0x0000000180501700-0x0000000180501820
	public void ResetToDesignSize(); // 0x00000001805023A0-0x0000000180502460
	private void OnEnable(); // 0x0000000180501E80-0x0000000180501EE0
	private void OnDisable(); // 0x0000000180501D90-0x0000000180501E80
	public void Refit(); // 0x0000000180502380-0x00000001805023A0
	public void SetTarget(float width, float height); // 0x0000000180502470-0x00000001805024A0
	public void RecaptureHome(); // 0x0000000180501F90-0x0000000180502030
	public void SetHome(Vector2 home); // 0x0000000180502460-0x0000000180502470
	public void PlayPop(float from = 0.8f /* Metadata: 0x0068C333 */, float duration = 0.3f /* Metadata: 0x0068C337 */); // 0x0000000180501EE0-0x0000000180501F40
	public void PlayPunch(float peak = 1.15f /* Metadata: 0x0068C33B */, float duration = 0.4f /* Metadata: 0x0068C33F */); // 0x0000000180501F40-0x0000000180501F90
	public void Apply(Sprite sp); // 0x0000000180501610-0x00000001805016E0
	private void EnsureParts(); // 0x0000000180501820-0x0000000180501AA0
	private void LateUpdate(); // 0x0000000180501AA0-0x0000000180501C50
	private void TickPop(); // 0x00000001805024A0-0x0000000180502640
	private void WriteRect(); // 0x00000001805028E0-0x0000000180502A60
	private bool NeedsRefit(Sprite sp); // 0x0000000180501C50-0x0000000180501D90
	private void Recompute(Sprite sp); // 0x0000000180502030-0x0000000180502380
	private bool TryContentBounds(Sprite sp, out Vector2 min, out Vector2 max); // 0x0000000180502640-0x00000001805028E0
}

...
public class PlayerUISlotPVP : MonoBehaviour // TypeDefIndex: 226
{
	...
	private const int LEGACY_IDX_IMAGE_AVT = 1; // Metadata: 0x0068AD60
	private const int LEGACY_IDX_LEVEL = 2; // Metadata: 0x0068AD61
	private const int LEGACY_IDX_USERNAME = 3; // Metadata: 0x0068AD62
	private const int LEGACY_IDX_PET = 4; // Metadata: 0x0068AD63
	private const int LEGACY_IDX_ENERGY = 5; // Metadata: 0x0068AD64
	private const int LEGACY_IDX_PASS = 6; // Metadata: 0x0068AD65
	...
	private const float RANK_POS_TTL = 120f; // Metadata: 0x0068AD66
	private const float RANK_POS_FAIL_BACKOFF = 30f; // Metadata: 0x0068AD6A
	...
	private sealed class __c__DisplayClass37_0 // TypeDefIndex: 227
	{
		...
		// Methods
		internal void _SetData_b__0(); // 0x0000000180840D50-0x0000000180840DC0
	}
	...
	private sealed class __c__DisplayClass44_0 // TypeDefIndex: 228
	{
		...
		// Methods
		internal void _ReplacePetAnimations_b__0(AnimationClip[] clips); // 0x0000000180840DC0-0x0000000180840E80
	}
	...
	private sealed class __c__DisplayClass52_0 // TypeDefIndex: 229
	{
		...
		// Methods
		internal void _LoadRankPositionForSlot_b__0(PvpProfileDTO data); // 0x0000000180840E80-0x00000001808410D0
		internal void _LoadRankPositionForSlot_b__1(string err); // 0x00000001808410D0-0x00000001808411A0
	}

	// Constructors
	public PlayerUISlotPVP(); // 0x0000000180837230-0x0000000180837250
	static PlayerUISlotPVP(); // 0x0000000180837090-0x0000000180837230

	// Methods
	private void Awake(); // 0x00000001808352D0-0x0000000180835300
	private void Start(); // 0x0000000180837000-0x0000000180837090
	private void AutoFillMissingRefs(); // 0x00000001808345F0-0x00000001808352D0
	public void SetData(PlayerUIModel model); // 0x0000000180835AB0-0x0000000180837000
	private static bool IsWsOwner(string userName); // 0x0000000180835300-0x0000000180835370
	public void ReplacePetAnimations(string petId); // 0x0000000180835740-0x0000000180835AB0
	private void ApplyPetClipsPvp(string petId, AnimationClip[] clips); // 0x0000000180834320-0x00000001808345F0
	private void LoadRankPositionForSlot(int userId); // 0x0000000180835370-0x0000000180835740
}

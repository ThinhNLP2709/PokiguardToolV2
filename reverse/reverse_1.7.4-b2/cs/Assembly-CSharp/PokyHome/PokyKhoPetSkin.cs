...
namespace PokyHome
{
	...
	public class PokyKhoPetSkin : MonoBehaviour // TypeDefIndex: 2243
	{
		// Fields
		...
		// Constructors
		public PokyKhoPetSkin(); // 0x0000000180789B90-0x0000000180789C10
	
		// Methods
		private void Awake(); // 0x0000000180789320-0x0000000180789620
		private static Image IconOf(Button slot); // 0x0000000180789620-0x00000001807896F0
		private void LateUpdate(); // 0x00000001807896F0-0x00000001807899B0
		private static void Mute(Button b); // 0x00000001807899B0-0x0000000180789AA0
		private static void Unmute(Button b); // 0x0000000180789AA0-0x0000000180789B90
	}
}

...
namespace PokyHome
{
	...
	public class PokyHubBinder : MonoBehaviour // TypeDefIndex: 2182
	{
		// Fields
		...
		private const string ARENA_ICON_NODE = "IconStone"; // Metadata: 0x0068E0F8
	
		// Properties
		public int BoundCount { [CompilerGenerated] get; [CompilerGenerated] private set; } // 0x0000000180770C80-0x0000000180770C90 0x0000000180770C90-0x0000000180770CA0
	
		// Constructors
		public PokyHubBinder(); // 0x00000001802EBA70-0x00000001802EBAF0
	
		// Methods
		public void Apply(ManagerQuangTruong hub); // 0x0000000180770080-0x00000001807707C0
		private void ApplyHonorIcon(); // 0x000000018076FF20-0x0000000180770080
		public void RefreshNow(); // 0x00000001807707D0-0x00000001807708D0
		public void Restore(); // 0x00000001807708D0-0x0000000180770C80
		private void OnDestroy(); // 0x00000001807707C0-0x00000001807707D0

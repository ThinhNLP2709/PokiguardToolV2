...
{
	[Serializable]
	public class EquipBagItemDTO // TypeDefIndex: 2385
	{
		// Fields
		...
		public bool isEquipped; // 0xB8
		public int slot; // 0xBC
	
		// Constructors
		public EquipBagItemDTO(); // 0x00000001802E9CB0-0x00000001802E9CC0
	
		// Methods
		public EquipItemDTO ToItem(); // 0x00000001807DCDD0-0x00000001807DCF40
	}
}

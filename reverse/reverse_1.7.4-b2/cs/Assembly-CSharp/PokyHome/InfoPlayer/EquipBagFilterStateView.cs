...
namespace PokyHome.InfoPlayer
{
	...
	public class EquipBagFilterStateView : MonoBehaviour // TypeDefIndex: 2339
	{
		// Fields
		...
		// Constructors
		public EquipBagFilterStateView(); // 0x00000001807C9980-0x00000001807C9A60
	
		// Methods
		public void Refresh(EquipCategory category, EquipSlot activeSlot, bool sortByPower); // 0x00000001807C98B0-0x00000001807C9980
		private void RefreshTabs(EquipCategory active, EquipSlot activeSlot); // 0x00000001807C9580-0x00000001807C98B0
		private void RefreshSlotFilters(EquipSlot active); // 0x00000001807C9340-0x00000001807C9580
	}
}

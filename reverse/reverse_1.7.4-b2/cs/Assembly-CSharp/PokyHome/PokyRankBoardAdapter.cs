...
namespace PokyHome
{
	...
	public class PokyRankBoardAdapter : MonoBehaviour // TypeDefIndex: 2252
	{
		// Fields
		...
		// Constructors
		public PokyRankBoardAdapter(); // 0x00000001802EBA70-0x00000001802EBAF0
	
		// Methods
		private void OnEnable(); // 0x000000018079B890-0x000000018079BDA0
		private void PreparePetAnimator(Transform row); // 0x000000018079BDA0-0x000000018079BF00
	}
}

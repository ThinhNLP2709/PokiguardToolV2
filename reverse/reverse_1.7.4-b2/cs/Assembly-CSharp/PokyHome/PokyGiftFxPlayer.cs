...
namespace PokyHome
{
	...
	public class PokyGiftFxPlayer : MonoBehaviour // TypeDefIndex: 2238
	{
		// Fields
		public const float FPS_POKY = 60f; // Metadata: 0x0068E32B
		public const int POKY_TICKS_PER_FRAME = 6; // Metadata: 0x0068E32F
		public const float POKY_SPIN_PER_TICK = -0.8f; // Metadata: 0x0068E330
		...
		// Properties
		public bool IsFinished { get; } // 0x00000001807816B0-0x00000001807816C0 
		public int CurrentFrame { get; } // 0x000000018039C0B0-0x000000018039C0C0 
		public int FrameCount { get; } // 0x0000000180781670-0x0000000180781690 
		private bool HasFrames { get; } // 0x0000000180781690-0x00000001807816B0 
	
		// Nested types
		public enum PlayMode // TypeDefIndex: 2239
		{
			Loop = 0,
			Once = 1,
			PingPong = 2
		...
		// Constructors
		public PokyGiftFxPlayer(); // 0x0000000180781650-0x0000000180781670
	
		// Methods
		public static PlayMode FromPokyTypeAnim(int typeAnim); // 0x0000000180781230-0x0000000180781250
		private void Awake(); // 0x0000000180781090-0x0000000180781140
		public void Play(); // 0x0000000180781250-0x0000000180781260
		private void OnEnable(); // 0x0000000180781250-0x0000000180781260
		private void Restart(); // 0x0000000180781260-0x00000001807813A0
		private void ApplyFrame(); // 0x0000000180780F30-0x0000000180781090
		private void Update(); // 0x00000001807813A0-0x0000000180781650
		private void Advance(); // 0x0000000180780E90-0x0000000180780F30
		private void EndOnce(); // 0x0000000180781140-0x0000000180781230
	}
}

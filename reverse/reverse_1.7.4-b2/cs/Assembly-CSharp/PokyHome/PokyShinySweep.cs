...
namespace PokyHome
{
	...
	public class PokyShinySweep : MonoBehaviour // TypeDefIndex: 2255
	{
		// Fields
		...
		// Nested types
		[CompilerGenerated]
		private sealed class __c__DisplayClass10_0 // TypeDefIndex: 2256
		{
			// Fields
			...
			// Methods
			internal void _Play_b__0(float v); // 0x00000001807AE9C0-0x00000001807AEA70
			internal void _Play_b__1(); // 0x00000001807AEA70-0x00000001807AEB50
		}
	
		// Constructors
		public PokyShinySweep(); // 0x000000018079CB10-0x000000018079CB30
	
		// Methods
		private void OnEnable(); // 0x000000018079C650-0x000000018079C770
		private void OnDisable(); // 0x000000018079C580-0x000000018079C650
		private void Update(); // 0x000000018079C9C0-0x000000018079CB10
		private void Play(); // 0x000000018079C770-0x000000018079C9C0
	}
}

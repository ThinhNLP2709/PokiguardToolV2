...
Disassembly:
	...
	mov [rcx+20h],rdx
	add rcx,20h
	call 000000018037ACB0h
	movzx esi,byte ptr [rbx+52h]
	mov rcx,rbx
	mov [rdi+40h],rdi
	call 000000018037ACE0h
	test al,al
	je short 00000001817DDD09h
	cmp sil,3
	jne short 00000001817DDD1Dh
	lea rax,[18009D2B0h]
	jmp short 00000001817DDD29h
	cmp sil,2
	jne short 00000001817DDD18h
	lea rax,[18009D1A0h]
	jmp short 00000001817DDD29h
	test rbp,rbp
	je short 00000001817DDD4Dh
	mov rax,[rdi+20h]
	mov [rdi+40h],rax
	mov rax,[rdi+10h]
	mov [rdi+18h],rax
	...
	lea rdx,[182A50388h]
	xor ecx,ecx
	call 000000018037B790h
	mov rcx,rax
	xor edx,edx
	call 000000018037BDF0h
...
ISIL:
	...
	013 Move [rcx+32], rdx
	014 Add rcx, rcx, 32
	015 Call 0x18037ACB0, rcx, rdx, r8, r9
	016 Move rsi, [rbx+82]
	017 Move rcx, rbx
	018 Move [rdi+64], rdi
	019 Call 0x18037ACE0, rcx, rdx, r8, r9
	020 Compare rax, 0
	021 JumpIfEqual {26}
	022 Compare rsi, 3
	023 JumpIfNotEqual {32}
	024 LoadAddress rax, [0x18009D2B0]
	025 Goto {35}
	026 Compare rsi, 2
	027 JumpIfNotEqual {30}
	028 LoadAddress rax, [0x18009D1A0]
	029 Goto {35}
	030 Compare rbp, 0
	031 JumpIfEqual {45}
	032 Move rax, [rdi+32]
	...
	034 Move rax, [rdi+16]
	035 Move [rdi+24], rax
	036 LoadAddress rax, [0x18029BCD0]
	...
	043 ShiftStack 8
	044 Return 
	045 LoadAddress rdx, [0x182A50388]
	046 Move rcx, 0
	047 Call 0x18037B790, rcx, rdx, r8, r9
	048 Move rcx, rax
	049 Move rdx, 0
	050 Call 0x18037BDF0, rcx, rdx, r8, r9
...
ISIL:
	...
	021 Call 0x18037B770, rcx, rdx, r8, r9
	022 ShiftStack 64
...
Disassembly:
	...
	mov rcx,rdx
	xor edx,edx
	call 000000018037B780h
	test rax,rax
	je short 0000000180C9C512h
	mov rcx,rax
	call 000000018037AE90h
	mov eax,[rax]
	add rsp,28h
	ret
	call 000000018037BE30h

ISIL:
	001 ShiftStack -40
	002 Move rcx, rdx
	003 Move rdx, 0
	004 Call 0x18037B780, rcx, rdx, r8, r9
	005 Compare rax, 0
	006 JumpIfEqual {12}
	007 Move rcx, rax
	...
	010 ShiftStack 40
	011 Return rax
	012 Call 0x18037BE30, rcx, rdx, r8, r9

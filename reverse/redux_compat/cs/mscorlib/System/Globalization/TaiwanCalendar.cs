...
namespace System.Globalization
{
	[Serializable]
	[ComVisible(true)]
	public class TaiwanCalendar : Calendar // TypeDefIndex: 3435
	{
		// Fields
		...
		// Properties
		[ComVisible(false)]
		public override DateTime MinSupportedDateTime { get; } // 0x000000018158C4A0-0x000000018158C4F0 
		[ComVisible(false)]
		public override DateTime MaxSupportedDateTime { get; } // 0x000000018158C450-0x000000018158C4A0 
		internal override int ID { get; } // 0x00000001804CB980-0x00000001804CB990 
		public override int[] Eras { get; } // 0x0000000181589D60-0x0000000181589D80 
		public override int TwoDigitYearMax { get; set; } // 0x0000000181589E20-0x0000000181589E70 0x000000018158C4F0-0x000000018158C630
	
		// Constructors
		public TaiwanCalendar(); // 0x000000018158C2F0-0x000000018158C450
		static TaiwanCalendar(); // 0x000000018158C180-0x000000018158C2F0
	
		// Methods
		internal static Calendar GetDefaultInstance(); // 0x000000018158BF30-0x000000018158BFF0
		...
		public override int ToFourDigitYear(int year); // 0x000000018158BFF0-0x000000018158C180
	}
}

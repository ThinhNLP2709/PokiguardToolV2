...
{
	internal class MD4Managed : MD4 // TypeDefIndex: 2130
	{
		// Fields
		...
		// Constructors
		public MD4Managed(); // 0x000000018144BBD0-0x000000018144BCE0
		...
		protected override byte[] HashFinal(); // 0x000000018144B8B0-0x000000018144BB70
		private byte[] Padding(int nLength); // 0x000000018144BB70-0x000000018144BBD0

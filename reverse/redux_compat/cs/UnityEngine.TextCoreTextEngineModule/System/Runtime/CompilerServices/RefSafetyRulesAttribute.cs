...
namespace System.Runtime.CompilerServices
{
	...
	[CompilerGenerated]
	[Embedded]
	internal sealed class RefSafetyRulesAttribute : Attribute // TypeDefIndex: 12614
	{
		// Fields
		public readonly int Version; // 0x10
	
		// Constructors
		public RefSafetyRulesAttribute(int param_00017f03); // 0x0000000181380310-0x0000000181380340
	}
}

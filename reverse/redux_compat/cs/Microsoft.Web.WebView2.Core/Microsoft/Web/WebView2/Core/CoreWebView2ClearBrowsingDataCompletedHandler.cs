...
{
	internal class CoreWebView2ClearBrowsingDataCompletedHandler : ICoreWebView2ClearBrowsingDataCompletedHandler, INotifyCompletion // TypeDefIndex: 10735
	{
		// Fields
		[CompilerGenerated]
		...
		// Constructors
		public CoreWebView2ClearBrowsingDataCompletedHandler(); // 0x00000001813C7360-0x00000001813C7380
	
		// Methods
		public void Invoke(int errCode); // 0x00000001813C72E0-0x00000001813C7310
		public CoreWebView2ClearBrowsingDataCompletedHandler GetAwaiter(); // 0x0000000180370C60-0x0000000180370C70

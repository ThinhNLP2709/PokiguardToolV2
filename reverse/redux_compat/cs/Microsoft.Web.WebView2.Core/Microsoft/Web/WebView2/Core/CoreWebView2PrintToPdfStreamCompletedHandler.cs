...
{
	internal class CoreWebView2PrintToPdfStreamCompletedHandler : ICoreWebView2PrintToPdfStreamCompletedHandler, INotifyCompletion // TypeDefIndex: 10772
	{
		// Fields
		[CompilerGenerated]
		...
		// Constructors
		public CoreWebView2PrintToPdfStreamCompletedHandler(); // 0x00000001813C72C0-0x00000001813C72E0
	
		// Methods
		public void Invoke(int errCode, IStream value); // 0x00000001813DED20-0x00000001813DED80
		public CoreWebView2PrintToPdfStreamCompletedHandler GetAwaiter(); // 0x0000000180370C60-0x0000000180370C70

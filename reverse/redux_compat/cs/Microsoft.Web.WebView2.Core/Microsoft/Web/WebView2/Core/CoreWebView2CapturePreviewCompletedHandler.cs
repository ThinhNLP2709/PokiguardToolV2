...
{
	internal class CoreWebView2CapturePreviewCompletedHandler : ICoreWebView2CapturePreviewCompletedHandler, INotifyCompletion // TypeDefIndex: 10658
	{
		// Fields
		[CompilerGenerated]
		...
		// Constructors
		public CoreWebView2CapturePreviewCompletedHandler(); // 0x00000001813C7360-0x00000001813C7380
	
		// Methods
		public void Invoke(int errCode); // 0x00000001813C72E0-0x00000001813C7310
		public CoreWebView2CapturePreviewCompletedHandler GetAwaiter(); // 0x0000000180370C60-0x0000000180370C70

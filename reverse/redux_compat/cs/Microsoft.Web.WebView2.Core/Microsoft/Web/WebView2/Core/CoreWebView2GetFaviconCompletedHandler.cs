...
{
	internal class CoreWebView2GetFaviconCompletedHandler : ICoreWebView2GetFaviconCompletedHandler, INotifyCompletion // TypeDefIndex: 10770
	{
		// Fields
		[CompilerGenerated]
		...
		// Constructors
		public CoreWebView2GetFaviconCompletedHandler(); // 0x00000001813C72C0-0x00000001813C72E0
	
		// Methods
		public void Invoke(int errCode, IStream value); // 0x00000001813DED20-0x00000001813DED80
		public CoreWebView2GetFaviconCompletedHandler GetAwaiter(); // 0x0000000180370C60-0x0000000180370C70

...
{
	internal class LightmapAOIntegrator : IDisposable // TypeDefIndex: 13548
	{
		// Fields
		...
		// Constructors
		public LightmapAOIntegrator(); // 0x00000001802E5CB0-0x00000001802E5CC0
		...
		public void Prepare(IRayTracingShader accumulationShader, ComputeShader normalizationShader, ComputeShader expansionHelpers, SamplingResources samplingResources, RTHandle emptyExposureTexture); // 0x0000000181DEF3F0-0x0000000181DEF500
		public void Accumulate(CommandBuffer cmd, uint sampleCountToTakePerTexel, uint currentSampleCountPerTexel, Matrix4x4 shaderLocalToWorld, Matrix4x4 shaderLocalToWorldNormals, int instanceGeometryIndex, int terrainIndex, Vector2Int instanceTexelSize, uint2 chunkOffset, World world, GraphicsBuffer traceScratchBuffer, GraphicsBuffer gBuffer, uint expandedSampleWidth, GraphicsBuffer expandedOutput, GraphicsBuffer compactedTexelIndices, GraphicsBuffer compactedGbufferLength, float pushOff, float aoMaxDistance, bool newChunkStarted); // 0x0000000181DEEB40-0x0000000181DEF1A0
		public void Normalize(CommandBuffer cmd, RenderTexture lightmap); // 0x0000000181DEF1C0-0x0000000181DEF3F0
	}
}

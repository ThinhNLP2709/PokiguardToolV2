...
{
	internal static class PluginsManager // TypeDefIndex: 13489
	{
		// Fields
		...
		private const int _MaxCustomPlugins = 20; // Metadata: 0x006A7A9F
		...
		public static ABSTweenPlugin<T1, T2, TPlugOptions> GetCustomPlugin<TPlugin, T1, T2, TPlugOptions>()
			...
			where TPlugOptions : struct, IPlugOptions;
		internal static void PurgeAll(); // 0x0000000180725970-0x0000000180725C50
	}
}

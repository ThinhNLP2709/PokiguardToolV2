...
{
	public abstract class Tweener : Tween // TypeDefIndex: 13449
	{
		// Fields
		...
		// Constructors
		internal Tweener(); // 0x0000000180718770-0x00000001807187A0
	
		// Methods
		public abstract Tweener ChangeStartValue(object newStartValue, float newDuration = -1f /* Metadata: 0x006A7A83 */);
		public abstract Tweener ChangeEndValue(object newEndValue, float newDuration = -1f /* Metadata: 0x006A7A87 */, bool snapStartValue = false /* Metadata: 0x006A7A8B */);
		public abstract Tweener ChangeEndValue(object newEndValue, bool snapStartValue);
		public abstract Tweener ChangeValues(object newStartValue, object newEndValue, float newDuration = -1f /* Metadata: 0x006A7A8C */);

...
namespace Unity.U2D.Physics
{
	...
	public struct PhysicsSliderJointDefinition // TypeDefIndex: 14669
	{
		// Fields
		...
		[SerializeField]
		private float m_SpringTargetTranslation; // 0x34
		[Min(0f)]
		[SerializeField]
		...
		[Min(0f)]
		[SerializeField]
		private float m_MaxMotorForce; // 0x48
		[SerializeField]
		private bool m_EnableLimit; // 0x4C
		[SerializeField]
		private float m_LowerTranslationLimit; // 0x50
		[SerializeField]
		private float m_UpperTranslationLimit; // 0x54
		[Min(0f)]
		[SerializeField]
		...
		// Properties
		public static PhysicsSliderJointDefinition defaultDefinition { get; } // 0x00000001822CA240-0x00000001822CA2F0 
	
		// Constructors
		public PhysicsSliderJointDefinition(); // 0x00000001822CA1A0-0x00000001822CA240
		public PhysicsSliderJointDefinition(bool useSettings); // 0x00000001822CA0F0-0x00000001822CA1A0
	}
}

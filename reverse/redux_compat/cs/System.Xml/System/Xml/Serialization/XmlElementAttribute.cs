...
namespace System.Xml.Serialization
{
	...
	public class XmlElementAttribute : Attribute // TypeDefIndex: 6942
	{
		// Fields
		...
		public int Order { get; } // 0x000000018033D790-0x000000018033D7A0 
		public Type Type { get; } // 0x00000001803272A0-0x00000001803272B0 
	
		// Constructors
		public XmlElementAttribute(string elementName); // 0x0000000181AABEA0-0x0000000181AABEE0
		public XmlElementAttribute(string elementName, Type type); // 0x0000000181AABE40-0x0000000181AABEA0
	
		// Methods
		internal void AddKeyHash(StringBuilder sb); // 0x0000000181AABCE0-0x0000000181AABE40
	}
}

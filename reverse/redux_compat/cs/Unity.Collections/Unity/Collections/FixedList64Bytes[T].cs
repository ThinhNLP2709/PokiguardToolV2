...
namespace Unity.Collections
{
		...
		where T : struct
	{
		...
		// Nested types
		public struct Enumerator : IEnumerator<T> // TypeDefIndex: 11501
		{
			// Fields
		...
		// Constructors
		public FixedList64Bytes([IsReadOnly] in FixedList32Bytes<T> other);
		public FixedList64Bytes([IsReadOnly] in FixedList128Bytes<T> other);
		public FixedList64Bytes([IsReadOnly] in FixedList512Bytes<T> other);
		public FixedList64Bytes([IsReadOnly] in FixedList4096Bytes<T> other);
		...
		[WriteAccessRequired]
		public static implicit operator Span<T>([IsReadOnly] in FixedList64Bytes<T> container);
		public static implicit operator ReadOnlySpan<T>([IsReadOnly] in FixedList64Bytes<T> container);
		[WriteAccessRequired]
		...
		public static bool operator ==([IsReadOnly] in FixedList64Bytes<T> a, [IsReadOnly] in FixedList32Bytes<T> b);
		public static bool operator !=([IsReadOnly] in FixedList64Bytes<T> a, [IsReadOnly] in FixedList32Bytes<T> b);
		...
		public static implicit operator FixedList64Bytes<T>([IsReadOnly] in FixedList32Bytes<T> other);
		public static bool operator ==([IsReadOnly] in FixedList64Bytes<T> a, [IsReadOnly] in FixedList64Bytes<T> b);
		public static bool operator !=([IsReadOnly] in FixedList64Bytes<T> a, [IsReadOnly] in FixedList64Bytes<T> b);
		public int CompareTo(FixedList64Bytes<T> other);
		public bool Equals(FixedList64Bytes<T> other);
		public static bool operator ==([IsReadOnly] in FixedList64Bytes<T> a, [IsReadOnly] in FixedList128Bytes<T> b);
		public static bool operator !=([IsReadOnly] in FixedList64Bytes<T> a, [IsReadOnly] in FixedList128Bytes<T> b);
		...
		public static implicit operator FixedList64Bytes<T>([IsReadOnly] in FixedList128Bytes<T> other);
		public static bool operator ==([IsReadOnly] in FixedList64Bytes<T> a, [IsReadOnly] in FixedList512Bytes<T> b);
		public static bool operator !=([IsReadOnly] in FixedList64Bytes<T> a, [IsReadOnly] in FixedList512Bytes<T> b);
		...
		public static implicit operator FixedList64Bytes<T>([IsReadOnly] in FixedList512Bytes<T> other);
		public static bool operator ==([IsReadOnly] in FixedList64Bytes<T> a, [IsReadOnly] in FixedList4096Bytes<T> b);
		public static bool operator !=([IsReadOnly] in FixedList64Bytes<T> a, [IsReadOnly] in FixedList4096Bytes<T> b);
		...
		public static implicit operator FixedList64Bytes<T>([IsReadOnly] in FixedList4096Bytes<T> other);

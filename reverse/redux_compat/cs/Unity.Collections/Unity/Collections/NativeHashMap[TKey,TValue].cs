...
{
	[DebuggerTypeProxy(typeof(NativeHashMapDebuggerTypeProxy<TKey, TValue>))]
	[GenerateTestsForBurstCompatibility(GenericTypeArguments = new Type[2] {typeof(int), typeof(int) })]
	[NativeContainer]
	public struct NativeHashMap<TKey, TValue> : INativeDisposable, IEnumerable<Unity.Collections.KVPair<TKey, TValue>> // TypeDefIndex: 11562
		...
		where TValue : struct
	{
		...
		public const int MaxCapacity = 536870912; // Metadata: 0x006A1C28
		...
		public struct Enumerator : IEnumerator<KVPair<TKey, TValue>> // TypeDefIndex: 11563
		{
			// Fields
			[NativeDisableUnsafePtrRestriction]
		...
		[NativeContainer]
		[NativeContainerIsReadOnly]
		public struct ReadOnly : IEnumerable<KVPair<TKey, TValue>> // TypeDefIndex: 11564
		{
			// Fields
			[NativeDisableUnsafePtrRestriction]
			internal unsafe HashMapHelper<TKey>* m_Data;

...
namespace Unity.Collections
{
		...
		where T : struct
	{
		...
		// Nested types
		public struct Enumerator : IEnumerator<T> // TypeDefIndex: 11509
		{
			// Fields
		...
		// Constructors
		public FixedList512Bytes([IsReadOnly] in FixedList32Bytes<T> other);
		public FixedList512Bytes([IsReadOnly] in FixedList64Bytes<T> other);
		public FixedList512Bytes([IsReadOnly] in FixedList128Bytes<T> other);
		public FixedList512Bytes([IsReadOnly] in FixedList4096Bytes<T> other);
		...
		[WriteAccessRequired]
		public static implicit operator Span<T>([IsReadOnly] in FixedList512Bytes<T> container);
		public static implicit operator ReadOnlySpan<T>([IsReadOnly] in FixedList512Bytes<T> container);
		[WriteAccessRequired]
		...
		public static bool operator ==([IsReadOnly] in FixedList512Bytes<T> a, [IsReadOnly] in FixedList32Bytes<T> b);
		public static bool operator !=([IsReadOnly] in FixedList512Bytes<T> a, [IsReadOnly] in FixedList32Bytes<T> b);
		...
		public static implicit operator FixedList512Bytes<T>([IsReadOnly] in FixedList32Bytes<T> other);
		public static bool operator ==([IsReadOnly] in FixedList512Bytes<T> a, [IsReadOnly] in FixedList64Bytes<T> b);
		public static bool operator !=([IsReadOnly] in FixedList512Bytes<T> a, [IsReadOnly] in FixedList64Bytes<T> b);
		...
		public static implicit operator FixedList512Bytes<T>([IsReadOnly] in FixedList64Bytes<T> other);
		public static bool operator ==([IsReadOnly] in FixedList512Bytes<T> a, [IsReadOnly] in FixedList128Bytes<T> b);
		public static bool operator !=([IsReadOnly] in FixedList512Bytes<T> a, [IsReadOnly] in FixedList128Bytes<T> b);
		...
		public static implicit operator FixedList512Bytes<T>([IsReadOnly] in FixedList128Bytes<T> other);
		public static bool operator ==([IsReadOnly] in FixedList512Bytes<T> a, [IsReadOnly] in FixedList512Bytes<T> b);
		public static bool operator !=([IsReadOnly] in FixedList512Bytes<T> a, [IsReadOnly] in FixedList512Bytes<T> b);
		public int CompareTo(FixedList512Bytes<T> other);
		public bool Equals(FixedList512Bytes<T> other);
		public static bool operator ==([IsReadOnly] in FixedList512Bytes<T> a, [IsReadOnly] in FixedList4096Bytes<T> b);
		public static bool operator !=([IsReadOnly] in FixedList512Bytes<T> a, [IsReadOnly] in FixedList4096Bytes<T> b);
		...
		public static implicit operator FixedList512Bytes<T>([IsReadOnly] in FixedList4096Bytes<T> other);
